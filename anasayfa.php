...
mysql_select_db($database_lmscon, $lmscon);
$query_dyroe = sprintf("SELECT DISTINCT DU.* FROM lms_ders DE, lms_sube SU, lms_duyuru DU WHERE DE.no = SU.dersno AND SU.kimlik = %s AND DE.aktif = 'EVET' AND (DU.kod = DE.no OR DU.kod = SU.subeadi) AND baslama <= DATE_FORMAT(now(), '%%Y-%%m-%%d') AND bitis >= DATE_FORMAT(now(), '%%Y-%%m-%%d') ORDER BY no DESC", GetSQLValueString($deger_dyroe, "text"));
...
mysql_select_db($database_lmscon, $lmscon);
$query_nd = sprintf("SELECT no FROM lms_not_defteri WHERE kimlik = %s AND nezaman = DATE_FORMAT(now(), '%%Y-%%m-%%d')", GetSQLValueString($bir_nd, "text"));
...
mysql_select_db($database_lmscon, $lmscon);
$query_dyrgnl = "SELECT * FROM lms_duyuru WHERE kod = 0 AND baslama <= DATE_FORMAT(now(), '%Y-%m-%d') AND bitis >= DATE_FORMAT(now(), '%Y-%m-%d') ORDER BY no DESC";
...
<!-- fwtable fwsrc="lms_ic.png" fwpage="LMS ic" fwbase="lms_ic.gif" fwstyle="Dreamweaver" fwdocid = "52238024" fwnested="0" -->
  ...
  <tr>
   ...
   <td rowspan="2" class="ustbaslik"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td>Öğretim Yönetim Sistemine Hoşgeldiniz</td>
       </tr>
     </table>
  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="60%" valign="top"><p class="baslik"><a href="#"><img src="resimler/gundem.jpg" border="0" /></a></p>
           <p class="baslik">Gündem: <span class="baslikMAVI">Üniversite</span> <span class="baslikMAVI">Kampüsleri Sayısallaşıyor.</span></p>
           <p class="arabaslik">Kontrolün tamamen sende olduğu bir öğrenim sürecine hazır   mısın?</p>
           <p class="icyazi">İstediğin zaman derse girebilir, istediğin zaman   arkadaşlarınla ya da ders sorumlusu ile mesajlaşabilir, ödevlerini, projelerini   sistem üzerinden takip edebilirsin.</p></td>
         <td width="40%" valign="top"><table width="100%" border="1" cellpadding="5" cellspacing="5" bordercolor="#333333" bgcolor="#F1F1F1">
           <tr>
             <td colspan="2" bordercolor="#F1F1F1" bgcolor="#F1F1F1"><span class="arabaslik">Posta Kutusu</span></td>
             <td width="9%" bordercolor="#F1F1F1" bgcolor="#F1F1F1"><a href="anasayfa.php" title="Yeni Mesaj Kontrol"><img src="simgeler/mesaj/kontrolet.gif" alt="Yeni Mesaj Kontrol" width="16" height="16" border="0" /></a></td>
             <td width="9%" bordercolor="#F1F1F1" bgcolor="#F1F1F1"><a href="mesajlar.php" title="Gelen Mesajlar"><img src="simgeler/mesaj/gelenler.gif" alt="Gelen Mesajlar" width="16" height="15" border="0" /></a></td>
             <td width="9%" bordercolor="#F1F1F1" bgcolor="#F1F1F1"><a href="mesaj_gonderilen.php" title="Gönderilmiş Mesajlar"><img src="simgeler/mesaj/gonderilenler.gif" alt="Gönderilmiş Mesajlar" width="16" height="15" border="0" /></a></td>
             <td width="9%" bordercolor="#F1F1F1" bgcolor="#F1F1F1"><a href="mesaj_gonder.php" title="Yeni Mesaj Oluştur"><img src="simgeler/mesaj/yeni.gif" alt="Yeni Mesaj Oluştur" width="16" height="15" border="0" /></a></td>
           </tr>
           <?php if ($totalRows_ym > 0) { // Show if recordset not empty ?>
             <tr>
               <td width="1%" bordercolor="#F1F1F1" bgcolor="#F1F1F1" class="icyazi"><a href="mesajlar.php"><img src="simgeler/mesaj/mesaj0.gif" alt="" width="13" height="11" border="0" /></a></td>
               <td colspan="5" bordercolor="#F1F1F1" bgcolor="#F1F1F1" class="icyazi"><a href="mesajlar.php"><?php echo $totalRows_ym ?> adet yeni mesajınız var.</a></td>
               </tr>
             <?php } // Show if recordset not empty ?>
             <?php if ($totalRows_ym == 0) { // Show if recordset empty ?>
               <tr>
                  <td width="1%" bordercolor="#F1F1F1" bgcolor="#F1F1F1" class="icyazi">&nbsp;</td>
                  <td colspan="5" bordercolor="#F1F1F1" class="icyazi">Yeni mesajınız yok.</td>
                </tr>
               <?php } // Show if recordset empty ?>
              <?php if ($totalRows_nd > 0) { // Show if recordset not empty ?>
                 <tr>
                   <td width="1%" bordercolor="#F1F1F1" bgcolor="#F1F1F1" class="icyazi"><img src="simgeler/notep_16.gif" alt="Hatırlatma Notu" width="16" height="16" /></td>
                   <td colspan="5" bordercolor="#F1F1F1" bgcolor="#F1F1F1" class="icyazi"><a href="not_defteri.php"><?php echo $totalRows_nd ?> adet hatırlatma notunuz var.</a></td>
                </tr>
                 <?php } // Show if recordset not empty ?>
           ...
           <table width="100%" border="1" cellpadding="5" cellspacing="5" bordercolor="#333333" bgcolor="#D7D7FF">
             <tr>
               <td colspan="2" bordercolor="#D7D7FF" class="arabaslik">Genel Duyurular - Haberler - Etkinlikler</td>
               <td width="1%" bordercolor="#D7D7FF" class="baslik"><div align="right"><a href="duyurular_arsiv.php" title="Arşive Git"><img src="simgeler/mesaj/arsiv.gif" alt="Arşive Git" width="16" height="15" border="0" /></a></div></td>
             </tr>
             <?php if ($totalRows_dyrgnl == 0) { // Show if recordset empty ?>
             <tr>
               <td colspan="3" bordercolor="#D7D7FF" class="icyazi">Yayında olan haber, duyuru ya da etkinlik yok.</td>
             </tr>
             <?php } // Show if recordset empty ?>
             <?php do { ?>
             <?php if ($totalRows_dyrgnl > 0) { // Show if recordset not empty ?>
             <tr>
               <td width="1%" bordercolor="#D7D7FF"><img src="resimler/new_16.gif" width="16" height="16" /></td>
               <td colspan="2" valign="top" bordercolor="#D7D7FF"><div align="left"><span class="icyazi"><a href="duyuru_ayrinti.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."duyuruno=".$row_dyrgnl['no'] ?>"><?php echo $row_dyrgnl['baslik']; ?></a></span></div></td>
             </tr>
             <?php } // Show if recordset not empty ?>
             <?php } while ($row_dyrgnl = mysql_fetch_assoc($dyrgnl)); ?>
             <?php if ($totalRows_dyrgnl > 5) {?>
             <tr>
               <td width="1%" bordercolor="#D7D7FF">&nbsp;</td>
               <td colspan="2" bordercolor="#D7D7FF" class="icyazi"><div align="center">
                 <table border="0">
                   <tr>
           ...
           <table width="100%" border="1" cellpadding="5" cellspacing="5" bordercolor="#333333" bgcolor="#FFFF66">
           <tr>
             <td colspan="2" bordercolor="#FFFF66" class="arabaslik">Duyuru Panosu (Dersler &amp; Şubeler)</td>
             <td width="1%" bordercolor="#FFFF66" class="baslik"><div align="right"><a href="duyurular_arsiv.php" title="Arşive Git"><img src="simgeler/mesaj/arsiv.gif" alt="Arşive Git" width="16" height="15" border="0" /></a></div></td>
           </tr>
           <?php if ($totalRows_dyr == 0) { // Show if recordset empty ?>
           <tr>
             <td colspan="3" bordercolor="#FFFF66" class="icyazi">Dersler ya da şubeler ile ilgili bir duyuru yok.</td>
           </tr>
           <?php } // Show if recordset empty ?>
           <?php do { ?>
           <?php if ($totalRows_dyr > 0) { // Show if recordset not empty ?>
           <tr>
             <td width="1%" bordercolor="#FFFF66"><img src="resimler/new_16.gif" width="16" height="16" /></td>
             <td colspan="2" valign="top" bordercolor="#FFFF66"><div align="left"><span class="icyazi"><a href="duyuru_ayrinti.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."duyuruno=".$row_dyr['no'] ?>"><?php echo $row_dyr['baslik']; ?></a></span></div></td>
             </tr>
           <?php } // Show if recordset not empty ?>
           <?php } while ($row_dyr = mysql_fetch_assoc($dyr)); ?>
           <?php if ($totalRows_dyr > 5) {?>
           <tr>
             <td width="1%" bordercolor="#FFFF66">&nbsp;</td>
             <td colspan="2" bordercolor="#FFFF66" class="icyazi"><div align="center">
               <table border="0">
                 <tr>
         ...
         <?php if ($row_tanitim['yetki'] < 5) {?>
           <table width="100%" border="1" cellpadding="5" cellspacing="5" bordercolor="#333333" bgcolor="#FFFF66">
             <tr>
               <td colspan="2" bordercolor="#FFFF66" class="arabaslik">Duyuru Panosu (Dersler &amp; Şubeler)</td>
               <td width="1%" bordercolor="#FFFF66" class="baslik"><div align="right"><a href="duyurular_arsiv.php"><img src="simgeler/mesaj/arsiv.gif" alt="Arşive Git" width="16" height="15" border="0" /></a></div></td>
             </tr>
             ...
             <tr>
               <td width="1%" bordercolor="#FFFF66"><img src="resimler/new_16.gif" width="16" height="16" /></td>
               <td colspan="2" valign="top" bordercolor="#FFFF66"><div align="left"><span class="icyazi"><a href="duyuru_ayrinti.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."duyuruno=".$row_dyroe['no'] ?>"><?php echo $row_dyroe['baslik']; ?></a></span></div></td>
             </tr>
             <?php } // Show if recordset not empty ?>
             <?php } while ($row_dyroe = mysql_fetch_assoc($dyroe)); ?>
             <?php if ($totalRows_dyroe > 5) {?>
			 <tr>
               <td width="1%" bordercolor="#FFFF66">&nbsp;</td>
               <td colspan="2" bordercolor="#FFFF66" class="icyazi"><div align="center">
                 <table border="0">
