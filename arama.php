...
//copyright (c)1998,2002 Yaromat.com
  ...
  if (myErr!=''){alert('Bilgi formunda eksik / hatalı alan var:\t\t\t\t\t\n\n'+myErr)}
  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellpadding="5" cellspacing="5">
       <tr>
         <td width="44%" valign="top" nowrap="nowrap" class="baslik">Sistem İçinde Kullanıcı Ara</td>
         <td width="31%" valign="top" class="arabaslik">Açıklama</td>
         <td width="25%" valign="top" class="arabaslik">Örnek Anahtar Kelime</td>
       </tr>
       <tr>
         <td valign="top"><form id="form1" name="form1" method="get" action="arama_sonuc.php">
           <table width="100%" border="0" cellspacing="2" cellpadding="3">

             <tr>
               <td width="23%" nowrap="nowrap" class="icyazi"><strong>Anahtar Kelime</strong></td>
               <td width="4%" class="icyazi"><strong>:</strong></td>
               <td width="26%" class="icyazi"><label>
                 <input name="anahtar" type="text" class="metinkutusu" id="anahtar" size="20" />
               </label></td>
               <td width="47%" class="icyazi"><label>
                 <input name="button" type="submit" class="buton" id="button" onclick="YY_checkform('form1','anahtar','#q','0','Anahtar Kelime');return document.MM_returnValue" value="Ara" />
               </label></td>
             </tr>
           </table>
                  </form>         </td>
         <td width="31%" valign="top"><span class="icyazi">Sistem içindeki kullanıcıları ad, soyad ya da kullanıcı adının tamamına ya da sadece bir bölümüne göre arayabilirsiniz</span></td>
         <td width="25%" valign="top"><ul>
           <li class="icyazi">Örnek 1: Ahmet</li>
           <li><span class="icyazi">Örnek 2: Ah</span></li>
           <li><span class="icyazi">Örnek 3: 20700001</span><br />
             </li>
         </ul></td>
       </tr>
       <tr>
         <td valign="top" nowrap="nowrap"><span class="baslik">İnternet'te Doküman / Bilgi Ara (Google)</span></td>
         <td valign="top"><span class="arabaslik">Açıklama</span></td>
         <td valign="top"><p><span class="arabaslik">Yardım</span></p>           </td>
       </tr>
       <tr>
         <td valign="top"><form action="http://www.google.com.tr/search" method="get" name="form2" target="_blank" id="form2">
           <table width="100%" border="0" cellspacing="2" cellpadding="3">
             ...
             <tr>
               ...
               <td width="4%" class="icyazi"><strong>:</strong></td>
               <td width="26%" class="icyazi"><label>
                 <input name="q" type="text" class="metinkutusu" id="q" size="20" />
               </label></td>
               <td width="47%" class="icyazi"><label>
                 <input name="button2" type="submit" class="buton" id="button2" value="Ara" />
               </label></td>
             </tr>
           </table>
         </form></td>
         <td valign="top"><span class="icyazi">İnternet üzerinde yer alan dokümanları ve bilgileri istediğiniz anahtar kelime / kelimeleri kullanarak arayabilirsiniz.</span></td>
         <td valign="top"><ul>
           <li class="icyazi"><a href="http://www.google.com.tr/intl/tr/help.html" target="_blank">Google yardım dokümanları</a></li>
          </ul></td>
       </tr>
       <tr>
         <td valign="top" nowrap="nowrap"><span class="baslik">Akademik Ağ'da Yayın Tara (Google Scholar)</span></td>
         <td valign="top"><span class="arabaslik">Açıklama</span></td>
         <td valign="top"><span class="arabaslik">Yardım</span></td>
       </tr>
       <tr>
         <td valign="top"><form action="http://scholar.google.com/scholar" method="get" name="form2" target="_blank" id="form3">
           <table width="100%" border="0" cellspacing="2" cellpadding="3">
             ...
             <tr>
               ...
               <td width="47%" class="icyazi"><label>
                 <input name="button3" type="submit" class="buton" id="button3" value="Ara" />
               </label></td>
             </tr>
           </table>
         </form></td>
         <td valign="top"><span class="icyazi">İnternet üzerinde yer alan akademik ağlardaki dokümanları  yazar adına, eser adına ya da istediğiniz anahtar kelime / kelimeleri kullarak arayabilirsiniz.</span></td>
         <td valign="top"><ul>
           <li><a href="http://scholar.google.com/intl/en/scholar/help.html" target="_blank" class="icyazi">Google Scholar yardım dokümanları</a></li>
         </ul></td>
       </tr>
     </table>
   <!-- InstanceEndEditable --></td>
