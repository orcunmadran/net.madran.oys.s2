...
mysql_select_db($database_lmscon, $lmscon);
$query_ist = "SELECT S.aciklama, COUNT(K.kimlik) AS mevcut FROM lms_kullanici K, lms_seviye S WHERE K.yetki = S.yetki GROUP BY K.yetki ORDER BY S.yetki";
...
if (isset($_GET['anahtar'])) {
  $deger_sonuc = $_GET['anahtar'];
}
mysql_select_db($database_lmscon, $lmscon);
$query_sonuc = sprintf("SELECT K.*, S.aciklama FROM lms_kullanici K, lms_seviye S WHERE (K.kimlik LIKE %s OR ad LIKE %s OR soyad LIKE %s) AND K.yetki = S.yetki ORDER BY soyad", GetSQLValueString($deger_sonuc . "%", "text"),GetSQLValueString("%" . $deger_sonuc . "%", "text"),GetSQLValueString("%" . $deger_sonuc . "%", "text"));
  ...
  <tr>
   ...
   <td rowspan="2" class="ustbaslik"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="7%"><a href="arama.php"><img src="simgeler/back_24.gif" alt="Yönetim paneline geri dön" width="24" height="24" border="0" /></a></td>
     ...
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="77%" valign="top"><?php if ($totalRows_sonuc == 0) { // Show if recordset empty ?>
             <table width="100%" border="0" cellspacing="5" cellpadding="5">
               <tr>
                 ...
                 <td width="99%" class="baslik">Kullanıcı bulunamadı</td>
               </tr>
               <tr>
                 <td>&nbsp;</td>
           ...
           <?php if ($totalRows_sonuc > 0) { // Show if recordset not empty ?>
             <table width="100%" border="0" cellspacing="2" cellpadding="3">
               <tr>
                 ...
                 <td colspan="2" nowrap="nowrap" class="arabaslik"><div align="center">İşlemler</div></td>
               </tr>
               <tr>
                 <td colspan="6" class="arabaslik"><hr size="1" /></td>
               </tr>
               <?php do { ?>
                 <tr>
                   <td class="icyazi"><div align="center"><a href="profil.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."kimlik=".$row_sonuc['kimlik'] ?>"><?php echo $row_sonuc['kimlik']; ?></a></div></td>
                   ...
                   <td width="1%" class="icyazi"><p><a href="profil_mesaj.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."kimlik=".$row_sonuc['kimlik'] ?>"><img src="simgeler/mail_16.gif" alt="Mesaj at" width="16" height="16" border="0" /></a></p>
                    </td>
                   <td width="1%" nowrap="nowrap" class="icyazi"><a href="profil_mesaj.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."kimlik=".$row_sonuc['kimlik'] ?>">Mesaj At</a></td>
                 </tr>
         ...
         <td width="23%" valign="top"><table border="0" align="center" cellpadding="3" cellspacing="2">
           ...
           <tr>
             <td><form id="form2" name="form2" method="get" action="arama_sonuc.php">
               <table border="0" align="center" cellpadding="3" cellspacing="2">
                 ...
                 <tr>
                   <td class="icyazi"><input name="button2" type="submit" class="buton" id="button2" onclick="YY_checkform('form2','anahtar','#q','0','Anahtar Kelime');return document.MM_returnValue" value="  Ara  " /></td>
                   </tr>
               </table>
                          </form>             </td>
           </tr>
           ...
           <tr>
             <td><table border="0" align="center" cellpadding="3" cellspacing="2">
               ...
               <?php do { ?>
                 <tr>
                   <td nowrap="nowrap" class="icyazi"><?php echo $row_ist['aciklama']; ?></td>
                   <td class="icyazi">:</td>
