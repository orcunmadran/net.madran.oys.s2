...
mysql_select_db($database_lmscon, $lmscon);
$query_ders = sprintf("SELECT DE.*, SU.kod AS subekodu, SU.no AS subeno, SU.kimlik AS sorumlu, CONCAT(K.ad, ' ', K.soyad) AS sadsoyad FROM lms_ders DE, lms_sube SU, lms_sinif SN, lms_kullanici K WHERE DE.no = SU.dersno AND SU.no = SN.subeno AND SN.kimlik = %s AND DE.no = %s AND SU.no = %s AND SU.kimlik = K.kimlik", GetSQLValueString($deger_ders, "text"),GetSQLValueString($degeriki_ders, "int"),GetSQLValueString($degeruc_ders, "int"));
...
$_SESSION['subeno'] = $row_ders['subeno'];
?>
       ...
       <tr>
         ...
         <?php if ($totalRows_ders > 0) {?>
           ...
           <tr>
             <td colspan="2" class="icyazi"><table width="100%" border="1" cellpadding="5" cellspacing="5" bordercolor="#CCCCCC">
               <tr>
                 <td width="11%" bordercolor="#FFFFFF"><img src="simgeler/mail_16.gif" alt="Ders Sorumlusu: <?php echo $row_ders['sadsoyad']; ?>" width="16" height="16" /></td>
                 <td width="89%" bordercolor="#FFFFFF"><a href="profil_mesaj.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."kimlik=".$row_ders['sorumlu'] ?>">Ders sorumlusuna mesaj gönder.</a></td>
               </tr>
             </table>               </td>
             </tr>
           <tr>
             <td colspan="2" class="icyazi"><table width="100%" border="1" cellpadding="5" cellspacing="5" bordercolor="#CCCCCC">
               <tr>
                 ...
                 <td width="89%" bordercolor="#FFFFFF"><a href="forum2.php?<?php echo $MM_keepURL; ?>">Dersin Tartışma Grubuna (Foruma) katıl.</a></td>
               </tr>
             </table></td>
           </tr>
           <tr>
             <td colspan="2" class="icyazi"><span class="arabaslik">Sohbet Gün ve Saatleri</span></td>
           </tr>
           <tr>
             <td colspan="2" class="icyazi"><table width="100%" border="1" cellpadding="5" cellspacing="5" bordercolor="#CCCCCC">
