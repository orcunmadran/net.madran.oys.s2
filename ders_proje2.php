...
if (isset($_POST[$MM_flag])) {
  $MM_dupKeyRedirect="ders_proje.php";
  $loginUsername = $_POST['dosyaadi'];
  $LoginRS__query = sprintf("SELECT dosyaadi FROM lms_odev WHERE dosyaadi=%s", GetSQLValueString($loginUsername, "text"));
  ...
  if($loginFoundUser){
    ...
    $MM_dupKeyRedirect = $MM_dupKeyRedirect . $MM_qsChar ."projeno=".$_SESSION['projeno'];
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO lms_odev (projeno, dosyaadi, orjinalad, guncelleme, kimlik) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['projeno'], "int"),
  ...
  $insertGoTo = "ders_proje.php?projeno=".$_SESSION['projeno'];
  if (isset($_SERVER['QUERY_STRING'])) {
...
//Dosya guvenlik Kodu
if($_POST['yuklendi'] == 1){
$dosyaadi = $_POST['yuklenenad'];
}else{
$gk = rand(1, 99999);
$dosyaadi = $_SESSION['projeno']."_".$_SESSION['MM_Username']."_".$gk.".".$dosyauzantisi;
}
//Kontrol İşlemi
...
// Yükleme İşlemi
	...
	if(is_uploaded_file($_FILES['dosya']['tmp_name'])){
		move_uploaded_file($_FILES['dosya']['tmp_name'], "odevler/".$dosyaadi);
  ...
  <tr>
   ...
   <td rowspan="2" class="ustbaslik"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="7%"><a href="ders_proje.php?projeno=<?php echo $_SESSION['projeno']; ?>"><img src="simgeler/back_24.gif" alt="Geri dön" width="24" height="24" border="0" /></a><a href="yonetim_ders_dokuman.php?dersno=<?php echo $_SESSION['dersno']; ?>"></a></td>
     ...
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         ...
         <table width="100%"  border="0" cellspacing="5" cellpadding="5">
           ...
           <tr class="arabaslik">
             <td>&nbsp;</td>
             <td>Doküman başarıyla yüklendi / güncellendi.</td>
           </tr>
           <tr>
             <td>&nbsp;</td>
             <td class="icyazi">Ödev &amp; Projenizi dersin danışmanına göndermek için &quot;Ödev &amp; Proje Gönder&quot; butonuna tıklayınız.</td>
           </tr>
           <tr class="icyazi">
             <td>&nbsp;</td>
             <td><form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
               <label>
               <input name="button" type="submit" class="buton" id="button" value="Ödev &amp; Proje Gönder" />
               </label>
               <input name="projeno" type="hidden" id="projeno" value="<?php echo $_SESSION['projeno']; ?>" />
...
<input name="kimlik" type="hidden" id="kimlik" value="<?php echo $_SESSION['MM_Username'];?>" />
         ...
         <?php if ($yuklendi == 0) { ?>
           <table width="100%"  border="0" cellspacing="5" cellpadding="5">
             ...
             <tr>
               <td class="icyazi">&nbsp;</td>
               <td class="icyazi">Yükleme sayfasına geri dönmek için <a href="ders_proje.php?projeno=<?php echo $_SESSION['projeno']; ?>">tıklayınız</a>.</td>
             </tr>
           </table>
           <?php } ?>
          </td>
