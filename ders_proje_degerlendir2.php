...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE lms_odev SET notu=%s, donut=%s WHERE `no`=%s",
                       GetSQLValueString($_POST['notu'], "int"),
                       GetSQLValueString($_POST['donut'], "text"),
  ...
  $updateGoTo = "ders_proje_degerlendir.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$degerbir_odev = "-1";
if (isset($_GET['odevno'])) {
  $degerbir_odev = $_GET['odevno'];
}
$degeriki_odev = "-1";
if (isset($_SESSION['MM_Username'])) {
...
mysql_select_db($database_lmscon, $lmscon);
$query_odev = sprintf("SELECT O.*, CONCAT(K.ad, ' ', K.soyad) AS adsoyad FROM lms_odev O, lms_proje P, lms_sube S, lms_ders D, lms_sinif SN, lms_kullanici K WHERE O.kimlik = K.kimlik AND O.projeno = P.no AND P.dersno = S.dersno AND S.no = SN.subeno AND O.kimlik = SN.kimlik AND O.no = %s AND S.kimlik = %s ORDER BY K.soyad", GetSQLValueString($degerbir_odev, "int"),GetSQLValueString($degeriki_odev, "text"));
...
<!-- fwtable fwsrc="lms_ic.png" fwpage="LMS ic" fwbase="lms_ic.gif" fwstyle="Dreamweaver" fwdocid = "52238024" fwnested="0" -->
  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="60%" class="baslik">Gönderilmiş Olan Ödev &amp; Proje</td>
       ...
       <tr>
         <td width="60%" valign="top"><form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
           <table width="100%" border="0" cellspacing="2" cellpadding="3">
             <tr>
               <td width="29%" nowrap="nowrap" class="icyazi"><strong>Öğrenci No</strong></td>
               <td width="2%" class="icyazi"><strong>:</strong></td>
               <td width="69%" class="icyazi"><?php echo $row_odev['kimlik']; ?></td>
             </tr>
             <tr>
               <td nowrap="nowrap" class="icyazi"><strong>Ad - Soyad</strong></td>
               <td class="icyazi"><strong>:</strong></td>
               <td class="icyazi"><?php echo $row_odev['adsoyad']; ?></td>
             </tr>
             <tr>
               <td nowrap="nowrap" class="icyazi"><strong>Gönderilme Tarihi</strong></td>
               <td class="icyazi"><strong>:</strong></td>
               <td class="icyazi"><?php echo $row_odev['guncelleme']; ?></td>
             </tr>
             <tr>
               <td nowrap="nowrap" class="icyazi"><strong>Gönderilen Doküman</strong></td>
               <td class="icyazi"><strong>:</strong></td>
               <td class="icyazi"><a href="odevler/<?php echo $row_odev['dosyaadi']; ?>" target="_blank"><?php echo $row_odev['dosyaadi']; ?></a></td>
             </tr>
             <tr>
               <td nowrap="nowrap" class="icyazi"><strong>Ödev &amp; Proje Notu</strong></td>
               <td class="icyazi"><strong>:</strong></td>
               <td class="icyazi"><label>
                 <input name="notu" type="text" class="metinkutusu" id="notu" value="<?php echo $row_odev['notu']; ?>" size="3" maxlength="3" />
                 (0 - 100)</label></td>
             </tr>
             <tr>
               <td valign="top" class="icyazi"><p><strong>Dönüt<br />
               </strong></p></td>
               <td valign="top" class="icyazi"><strong>:</strong></td>
               <td valign="top" class="icyazi"><label>
                 <textarea name="donut" cols="45" rows="5" class="metinkutusu" id="donut"><?php echo $row_odev['donut']; ?></textarea>
                 <br />
                 (En fazla 255 karakter)</label></td>
             </tr>
             <tr>
               <td class="icyazi"><input name="no" type="hidden" id="no" value="<?php echo $row_odev['no']; ?>" /></td>
               <td class="icyazi">&nbsp;</td>
               <td class="icyazi"><label>
                 <input name="button" type="submit" class="buton" id="button" value="Değerlendirmeyi Gönder" />
               </label></td>
             </tr>
           </table>
