...
mysql_select_db($database_lmscon, $lmscon);
$query_ders = sprintf("SELECT DE.* FROM lms_ders DE WHERE DE.kimlik = %s AND DE.no = %s", GetSQLValueString($deger_ders, "text"),GetSQLValueString($degeriki_ders, "int"));
  ...
  <tr>
   ...
   <td rowspan="2" class="ustbaslik"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="3%" valign="top"><a href="yonetim_dersler.php"><img src="simgeler/back_24.gif" alt="Geri Dön" width="24" height="24" border="0" /></a></td>
         <td width="97%" valign="top"><?php echo $row_ders['kod']; ?> -   <?php echo $row_ders['ad']; ?></td>
       </tr>
     </table>
     ...
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         ...
         <?php if ($totalRows_ders > 0) {?>
			<table width="95%" border="0" align="right" cellpadding="5" cellspacing="5">
           <tr>
             <td class="baslik">Eğitim Araçları</td>
           </tr>
           <tr>
             <td><span class="arabaslik">Etkileşimli Eğitim</span></td>
           </tr>
           <tr>
             <td><table width="100%" border="1" cellpadding="5" cellspacing="5" bordercolor="#CCCCCC">
           ...
           <tr>
             <td class="arabaslik">Kaynak Dokümanlar</td>
           </tr>
           <tr>
             <td><table width="100%" border="1" cellpadding="5" cellspacing="5" bordercolor="#CCCCCC">
           ...
           <tr>
             <td class="arabaslik">Çevrimiçi Kaynaklar</td>
           </tr>
           <tr>
             <td><table width="100%" border="1" cellpadding="5" cellspacing="5" bordercolor="#CCCCCC">
           ...
           <tr>
             <td class="arabaslik">Ödevler ve Projeler</td>
           </tr>
           <tr>
             <td class="icyazi"><table width="100%" border="1" cellpadding="5" cellspacing="5" bordercolor="#CCCCCC">
