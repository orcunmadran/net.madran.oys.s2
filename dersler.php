       ...
       <tr>
         <td><table border="0" cellspacing="5" cellpadding="5">
           <?php if ($totalRows_ders == 0) { // Show if recordset empty ?>
             <tr>
               <td colspan="6"><table width="100%" border="0" cellspacing="2" cellpadding="3">
                      <tr>
                      ...
                      <tr>
                        <td>&nbsp;</td>
                        <td nowrap="nowrap" class="icyazi">Sistem tarafından size yüklenen herhangi bir ders bulunmamaktadır.</td>
                      </tr>
			...
			<?php if ($totalRows_ders > 0) { ?>
             ...
             <td nowrap="nowrap" bgcolor="#F1F1F1" class="arabaslik">Dersin Adı</td>
             <td nowrap="nowrap" bgcolor="#F1F1F1" class="arabaslik">Ders Sorumlusu</td>
             <td nowrap="nowrap" bgcolor="#F1F1F1" class="arabaslik">Ders Hakkında</td>
             <td nowrap="nowrap" bgcolor="#F1F1F1" class="arabaslik">Sınıf Listesi</td>
             </tr>
           <?php do { ?>
             <tr>
               <td valign="top" nowrap="nowrap" class="icyazi"><div align="center"><?php echo $row_ders['kod']; ?></div></td>
               <td valign="top" nowrap="nowrap" class="icyazi"><div align="center"><?php echo $row_ders['subekodu']; ?></div></td>
               <td valign="top" nowrap="nowrap" class="icyazi"><a href="ders2.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."dersno=".$row_ders['no']."&"."subeno=".$row_ders['subeno'] ?>"><?php echo $row_ders['ad']; ?></a></td>
               <td valign="top" nowrap="nowrap" class="icyazi"><a href="profil.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."kimlik=".$row_ders['sorumlu'] ?>"><?php echo $row_ders['adsoyad']; ?></a></td>
               <td valign="top" class="icyazi"><div align="left"><?php echo $row_ders['tanim']; ?></div></td>
               <td valign="top" nowrap="nowrap" class="icyazi"><a href="yonetim_sube_ogrenci_liste.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."subeno=".$row_ders['subeno'] ?>" title="Sınıf listesini görüntüle" target="_blank">
               <div align="center"><img src="simgeler/paste_16.gif" alt="S&#305;n&#305;f listesini g&ouml;r&uuml;nt&uuml;le" border="0" /></div>
               </a></td>
             </tr>
         ...
         <td><table border="0" cellspacing="5" cellpadding="5">
           ...
           <?php do { ?>
             <tr>
               ...
               <td valign="top" nowrap="nowrap" class="icyazi"><a href="ders.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."dersno=".$row_subeler['no']."&"."subeno=".$row_subeler['subeno'] ?>"><?php echo $row_subeler['ad']; ?></a></td>
               <td valign="top" nowrap="nowrap" class="icyazi"><a href="profil.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."kimlik=".$row_subeler['sorumlu'] ?>"><?php echo $row_subeler['adsoyad']; ?></a></td>
               <td valign="top" class="icyazi"><div align="left"><?php echo $row_subeler['tanim']; ?></div></td>
               <td valign="top" nowrap="nowrap" class="icyazi"><div align="center"><a href="yonetim_sube_ogrenci_liste.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."subeno=".$row_subeler['subeno'] ?>" target="_blank"><img src="simgeler/paste_16.gif" alt="Sınıf listesini görüntüle" border="0" /></a></div></td>
             </tr>
