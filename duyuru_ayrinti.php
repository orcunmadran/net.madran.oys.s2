...
mysql_select_db($database_lmscon, $lmscon);
$query_duyuru = sprintf("SELECT DU.*, DATE_FORMAT(DU.baslama, '%%d.%%m.%%Y') AS tarih, CONCAT(K.ad, ' ', K.soyad) AS adsoyad FROM lms_duyuru DU, lms_kullanici K WHERE DU.no = %s AND DU.kimlik = K.kimlik", GetSQLValueString($iki_duyuru, "int"));
   ...
   <td rowspan="2" class="ustbaslik"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         ...
         <td width="93%">Haber - Duyuru - Etkinlik Ayrıntı</td>
       </tr>
     </table>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         ...
         <td width="40%" rowspan="2" valign="top"><table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
           <tr>
       ...
       <tr>
         <td valign="top"><table width="100%" border="1" cellpadding="5" cellspacing="5" bordercolor="#CCCCCC" bgcolor="#FFFFFF">
             <tr>
               <td colspan="4" valign="top" bordercolor="#FFFFFF"><span class="baslikMAVI"><?php echo $row_duyuru['baslik']; ?></span></td>
               <td width="1%" valign="top" nowrap="nowrap" bordercolor="#FFFFFF"><div align="right" class="baslikMAVI"><?php echo $row_duyuru['tarih']; ?></div></td>
             </tr>
             <tr>
               <td colspan="5" bordercolor="#FFFFFF"><p class="icyazi"><?php echo $row_duyuru['icerik']; ?></p></td>
              </tr>
             <tr>
               <td colspan="5" bordercolor="#FFFFFF" class="icyazi"><strong><?php echo $row_duyuru['adsoyad']; ?></strong></td>
             </tr>
