  ...
  <tr>
   ...
   <td rowspan="2" class="ustbaslik"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="3%" valign="top"><a href="javascript:history.back()"><img src="simgeler/back_24.gif" alt="Geri Dön" width="24" height="24" border="0" /></a></td>
             ...
             <table width="100%" border="0" cellspacing="2" cellpadding="3">
               <?php do { ?>
                 <tr>
                   ...
                   <td nowrap="nowrap" class="arabaslik"><div align="right"><?php echo $row_ders['zaman']; ?></div></td>
                 </tr>
                 <tr>
                   <td>&nbsp;</td>
                   <td valign="top" class="icyazi"><?php echo $row_ders['forumaciklama']; ?></td>
                   <td valign="bottom" class="icyazi">&nbsp;</td>
                  </tr>
                 <tr>
                   <td>&nbsp;</td>
