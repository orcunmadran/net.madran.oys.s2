...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "islem")) {
  $updateSQL = sprintf("UPDATE lms_forum_yorum SET engelle=%s WHERE `no`=%s",
                       GetSQLValueString($_POST['engelle'], "int"),
...
<form id="islem" name="islem" method="POST" action="<?php echo $editFormAction; ?>">
  <input name="no" type="hidden" id="no" value="<?php echo $_GET['yorumno'] ?>" />
  <input name="engelle" type="hidden" id="engelle" value="<?php echo $_GET['engelle'] ?>" />
