...
<!-- fwtable fwsrc="lms_ic.png" fwpage="LMS dis" fwbase="lms_dis.gif" fwstyle="Dreamweaver" fwdocid = "1032219995" fwnested="0" -->
  ...
  <tr>
   ...
   <td colspan="9"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="60%" class="ustbaslik">Kullanıcı Girişi</td>
         <td width="40%" class="ustbaslik">&nbsp;</td>
       </tr>
     </table>
  ...
  <tr>
   ...
   <td colspan="9" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="35%"><form id="giris" name="giris" method="POST" action="<?php echo $loginFormAction; ?>">
             <table border="0" cellspacing="2" cellpadding="3">
               <tr>
                 <td nowrap="nowrap" class="arabaslik">Kullanıcı Adı</td>
               ...
               <tr>
                 ...
                 <td class="arabaslik">:</td>
                 <td nowrap="nowrap"><input name="sifre" type="password" class="metinkutusu" id="sifre" size="20" maxlength="20" />
         ...
         <td width="24%" valign="top"><div align="center"><a href="index_yardim_giris.php"><img src="resimler/giris_egitim.gif" width="150" height="75" border="0" /></a></div></td>
         <td width="41%" rowspan="5" valign="top"><table width="90%" border="0" align="right" cellpadding="5" cellspacing="5">
             <tr>
               <td colspan="2"><div align="center" class="baslik">
                 <div align="left">Sistem Gereksinimleri</div>
               </div></td>
             </tr>
             <tr>
               <td colspan="2" class="icyazi"><p>Öğretim Yönetim Sistemi içerisindeki bazı içerik ve dokümanlari görüntüleyebilmeniz için aşağıda listelenmiş eklentilere ihtiyaç duyabilirsiniz.</p>
                   <p>Eklentileri İnternet üzerinden ücretsiz olarak yükleyebilirsiniz.</p></td>
             </tr>
             <tr>
               <td colspan="2" class="arabaslik">Eklentiler:</td>
             </tr>
             <tr>
               <td width="38%" nowrap="nowrap" class="icyazi">ADOBE READER</td>
               <td width="62%" nowrap="nowrap" class="arabaslik"><a href="http://www.adobe.com/products/acrobat/readstep2.html" target="_blank"><img src="resimler/get_adobe_reader.gif" title="ADOBE READER eklentisini indirmek için tıklayınız." width="112" height="33" border="0" /></a></td>
             </tr>
             <tr>
               <td nowrap="nowrap" class="icyazi">ADOBE FLASH PLAYER</td>
               <td nowrap="nowrap" class="arabaslik"><a href="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash&amp;promoid=BIOW" target="_blank"><img src="resimler/get_flash_player.gif" title="ADOBE FLASH PLAYER eklentisini indirmek için tıklayınız." width="88" height="31" border="0" /></a></td>
             </tr>
         </table></td>
       </tr>
       <tr>
       ...
       <tr>
         <td colspan="2" class="icyazi"><table width="100%" border="0" cellspacing="2" cellpadding="3">
             <tr>
               <td valign="top">* </td>
               <td>Kullanıcı adı olarak; öğrenci iseniz öğrenci numaranızı, öğretim elemanı iseniz kurum kullanıcı adınızı kullanınız.</td>
             </tr>
             <tr>
               <td valign="top">**</td>
               <td>Öğretim Yönetim Sistemi için daha önce giriş şifresi almadıysanız ya da şifrenizi unuttuysanız aşağıdaki bölümden sisteme kayıtlı olduğunuz e-posta adresi ile şifre talebinde bulunabilirsiniz.</td>
             </tr>
         </table></td>
       </tr>
       <tr>
         <td colspan="2" class="icyazi"><hr size="1" /></td>
       </tr>
       <tr>
         <td colspan="2" class="arabaslik"><form id="unuttum" name="unuttum" method="post" action="index_bilgi.php">
             <label> Şifre talebi:
               <input name="eposta" type="text" class="metinkutusu" id="eposta" value="e-posta adresinizi giriniz" size="30" maxlength="50" />
             </label>
             <label>
