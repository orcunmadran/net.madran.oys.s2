<?php
include("Connections/lmscon.php");
session_start();
if($_SESSION['kod'] == $_POST['dogrulama']){
$mesajsonuc = 1;
	//E-Posta
	...
	$mailcontent=
	"Öğretim Yönetim Sistemi dış iletişim formu"."\n\r"."<br>".
	"------------------------------------------"."\n\r"."<br>".
	...
	mail($yonetimeposta, $var_konu, $mailcontent, "From: $var_eposta\n".'Content-type: text/html; charset=UTF-8');
}
else{
$mesajsonuc = 0;
}
  ...
  <tr>
   ...
   <td colspan="9"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td class="ustbaslik">İletişim Sonuç</td>
        </tr>
     </table>
  ...
  <tr>
   ...
   <td colspan="9" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <?php if ($mesajsonuc == 1){ ?>
       <tr>
         <td width="4%" valign="top" class="arabaslik"><img src="simgeler/about_24.gif" width="24" height="24" /></td>
         <td width="96%" valign="top"><p class="baslikMAVI">Mesajınız Başarıyla İletildi.</p>
          <p class="arabaslik">İletişim formunda belirtmiş olduğunuz e-posta adresi aracılığıyla sizinle bağlantıya geçilecektir.</p></td>
       </tr>
       <?php } else { ?>
       <tr>
         <td width="4%" valign="top" class="arabaslik"><img src="simgeler/stop_24.gif" width="24" height="24" /></td>
         <td valign="top"><p class="baslik">Güvenlik Kodu Hatalı.</p>
           <p class="arabaslik"> Formu göndermeden önce güvenlik kodunu ilgili metin kutusuna doğru girdiğinizden emin olun.</p>
           <p class="arabaslik"><a href="javascript:history.back()"><img src="resimler/guvenlik_ornek.gif" alt="İletişim formuna geri dön" width="342" height="71" border="0" /></a></p>
          <p class="icyazi">İletişim formuna geri dönmek için <a href="javascript:history.back()">tıklayınız</a>.</p></td>
       </tr>
       <?php }?>
     </table>
   <!-- InstanceEndEditable --></td>
