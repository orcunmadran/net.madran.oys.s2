...
mysql_select_db($database_lmscon, $lmscon);
$query_m = sprintf("SELECT M.*, DATE_FORMAT(zaman, '%%d.%%m.%%Y - %%H:%%i') AS tarihsaat, CONCAT(K.ad, ' ', K.soyad) AS adsoyad  FROM lms_mesaj M, lms_kullanici K WHERE M.no = %s AND M.alici LIKE %s AND M.gonderen = K.kimlik", GetSQLValueString($degerbir_m, "int"),GetSQLValueString("%" . $degeriki_m . "%", "text"));
...
<!-- fwtable fwsrc="lms_ic.png" fwpage="LMS ic" fwbase="lms_ic.gif" fwstyle="Dreamweaver" fwdocid = "52238024" fwnested="0" -->
  ...
  <tr>
   ...
   <td rowspan="2" class="ustbaslik"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="7%"><a href="mesajlar.php"><img src="simgeler/back_24.gif" alt="Geri dön" width="24" height="24" border="0" /></a></td>
         <td width="93%">Mesaj</td>
       </tr>
     </table>
  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="75%" valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="3">
           <tr>
             <td width="15%" nowrap="nowrap" class="icyazi"><strong>Gönderen</strong></td>
             <td width="2%" class="icyazi"><strong>:</strong></td>
             <td colspan="4" class="icyazi"><?php echo $row_m['adsoyad']; ?></td>
           </tr>
           <tr>
             <td nowrap="nowrap" class="icyazi"><strong>Alıcı / Alıcılar</strong></td>
             <td class="icyazi"><strong>:</strong></td>
             <td colspan="4" class="icyazi"><?php echo $row_m['alici']; ?></td>
           </tr>
           <tr>
             <td nowrap="nowrap" class="icyazi"><strong>Tarih - Saat</strong></td>
             <td class="icyazi"><strong>:</strong></td>
             <td colspan="4" class="icyazi"><?php echo $row_m['tarihsaat']; ?></td>
           </tr>
           <tr>
             <td nowrap="nowrap" class="icyazi"><strong>Konu</strong></td>
             <td class="icyazi"><strong>:</strong></td>
             <td width="71%" class="icyazi"><?php echo $row_m['konu']; ?></td>
             <td width="4%" class="icyazi"><a href="mesaj_cevap.php?<?php echo $MM_keepURL; ?>"><img src="simgeler/mesaj/cevap.gif" alt="Cevap Yaz" width="16" height="15" border="0" /></a></td>
             <td width="4%" class="icyazi"><a href="mesaj_ilet.php?<?php echo $MM_keepURL; ?>"><img src="simgeler/mesaj/yonlendir.gif" alt="&#304;let" width="16" height="15" border="0" /></a></td>
             <td width="4%" class="icyazi"><a href="mesajlar_sil.php?<?php echo $MM_keepURL; ?>"><img src="simgeler/mesaj/sil.gif" alt="Sil" width="16" height="14" border="0" onclick="GP_popupConfirmMsg('Mesaj, posta kutunuzdan tamamen silinecektir!');return document.MM_returnValue" /></a></td>
           </tr>
           <tr>
             <td valign="top" nowrap="nowrap" class="icyazi">&nbsp;</td>
             <td valign="top" class="icyazi">&nbsp;</td>
             <td colspan="4" class="icyazi"><hr size="1" /></td>
           </tr>
           <tr>
             <td valign="top" nowrap="nowrap" class="icyazi">&nbsp;</td>
             <td valign="top" class="icyazi">&nbsp;</td>
             <td colspan="4" class="icyazi"><?php echo str_replace("\n","<br>", $row_m['icerik']); ?></td>
           </tr>
         </table></td>
