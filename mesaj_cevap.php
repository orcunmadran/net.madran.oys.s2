         ...
         <td width="75%" valign="top"><form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
           <table width="100%" border="0" cellspacing="5" cellpadding="5">
             ...
             <tr>
               ...
               <td class="icyazi"><?php echo $row_tanitim['ad']; ?> <?php echo $row_tanitim['soyad']; ?>
                 <input name="gonderen" type="hidden" id="gonderen" value="<?php echo $row_tanitim['kimlik']; ?>" /></td>
             </tr>
             <tr>
               ...
               <td valign="top" class="icyazi"><label></label>
                    <label class="icyazi"><?php echo $row_m['adsoyad']; ?> 
                    <input name="alici" type="hidden" id="alici" value="<?php echo $row_m['gonderen']; ?>" />
                    </label></td>
               </tr>
             <tr>
               <td class="icyazi"><div align="left"><strong>Konu</strong></div></td>
               <td class="icyazi"><strong>:</strong></td>
               <td class="icyazi"><input name="konu" type="text" class="metinkutusu" id="konu" value="<?php echo "Cevap: ".$row_m['konu']; ?>" size="65" maxlength="100" />
             ...
             <tr>
               ...
               <td valign="top" class="icyazi"><label>
                 <textarea name="icerik" cols="80" rows="7" class="metinkutusu" id="icerik">


Orjinal Mesaj
----------------
Gönderen: <?php echo $row_m['adsoyad']; ?>

Alıcı: <?php echo $row_m['alici']; ?>

Tarih - Saat: <?php echo $row_m['tarihsaat']; ?>


<?php echo $row_m['icerik']; ?></textarea>
