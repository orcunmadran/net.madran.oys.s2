...
$degerbir_m = "-1";
if (isset($_SESSION['MM_Username'])) {
  $degerbir_m = $_SESSION['MM_Username'];
}
mysql_select_db($database_lmscon, $lmscon);
$query_m = sprintf("SELECT M.*,CONCAT(SUBSTRING(M.alici, 1, 20), '...') AS alicilar, DATE_FORMAT(zaman, '%%d.%%m.%%Y - %%H:%%i') AS tarihsaat FROM lms_mesaj M WHERE M.gonderen = %s AND M.silindi NOT LIKE %s ORDER BY M.zaman DESC", GetSQLValueString($degerbir_m, "text"),GetSQLValueString("%" . $degerbir_m . "%", "text"));
   ...
   <td rowspan="2" class="ustbaslik"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         ...
         <td width="93%">Gönderilmiş Mesajlar</td>
       </tr>
     </table>
     ...
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="75%" valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="3">
           <tr>
             <td width="2%">&nbsp;</td>
             <td width="30%" nowrap="nowrap" class="arabaslik"><div align="left">Alıcı / Alıcılar</div></td>
             <td width="48%" class="arabaslik">Konu</td>
             <td width="15%" nowrap="nowrap" class="arabaslik"><div align="center">Tarih - Saat</div></td>
             <td width="15%" nowrap="nowrap" class="arabaslik"><div align="center">Sil</div></td>
           </tr>
           <tr>
             <td>&nbsp;</td>
             <td><hr size="1" /></td>
           ...
           <?php do { ?>
             <?php if ($totalRows_m > 0) { // Show if recordset not empty ?>
               <tr>
                 <td valign="top"><img src="simgeler/mesaj/gonderilenler.gif" title="Mesajı okuyan kullanıcıların listesi: <?php echo $row_m['okundu']; ?>" width="16" height="15" /></td>
                   <td valign="top" class="icyazi"><div align="left"><?php echo $row_m['alicilar']; ?></div></td>
                     <td valign="top" class="icyazi"><a href="mesaj_gonderilmis.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."mesajno=".$row_m['no'] ?>"><?php echo $row_m['konu']; ?></a></td>
                     <td valign="top" nowrap="nowrap" class="icyazi"><div align="center"><?php echo $row_m['tarihsaat']; ?></div></td>
                     <td valign="top" nowrap="nowrap" class="icyazi"><div align="center"><a href="mesajlar_gonderilmis_sil.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."mesajno=".$row_m['no'] ?>"><img src="simgeler/mesaj/sil.gif" alt="Mesajı Sil" width="16" height="14" border="0" onclick="GP_popupConfirmMsg('Mesaj posta kutunuzdan tamamen silinecektir!');return document.MM_returnValue" /></a></div></td>
                  </tr>
