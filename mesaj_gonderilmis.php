...
mysql_select_db($database_lmscon, $lmscon);
$query_m = sprintf("SELECT M.*, DATE_FORMAT(zaman, '%%d.%%m.%%Y - %%H:%%i') AS tarihsaat, CONCAT(K.ad, ' ', K.soyad) AS adsoyad FROM lms_mesaj M, lms_kullanici K WHERE M.no = %s AND M.gonderen = %s AND M.gonderen = K.kimlik", GetSQLValueString($degerbir_m, "int"),GetSQLValueString($degeriki_m, "text"));
  ...
  <tr>
   ...
   <td rowspan="2" class="ustbaslik"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="7%"><a href="mesaj_gonderilen.php"><img src="simgeler/back_24.gif" alt="Geri dön" width="24" height="24" border="0" /></a></td>
       ...
       <tr>
         <td width="75%" valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="3">
           <tr>
             ...
             <td colspan="2" class="icyazi"><?php echo $row_m['adsoyad']; ?></td>
           </tr>
           <tr>
             <td nowrap="nowrap" class="icyazi"><strong>Alıcı / Alıcılar</strong></td>
             <td class="icyazi"><strong>:</strong></td>
             <td colspan="2" class="icyazi"><?php echo $row_m['alici']; ?></td>
           </tr>
           <tr>
             <td nowrap="nowrap" class="icyazi"><strong>Tarih - Saat</strong></td>
             <td class="icyazi"><strong>:</strong></td>
             <td colspan="2" class="icyazi"><?php echo $row_m['tarihsaat']; ?></td>
           </tr>
           <tr>
             <td nowrap="nowrap" class="icyazi"><strong>Konu</strong></td>
             <td class="icyazi"><strong>:</strong></td>
             <td class="icyazi"><?php echo $row_m['konu']; ?></td>
             <td width="1%" class="icyazi"><a href="mesaj_ilet.php?<?php echo $MM_keepURL; ?>"><img src="simgeler/mesaj/yonlendir.gif" alt="&#304;let" width="16" height="15" border="0" /></a></td>
             </tr>
           <tr>
