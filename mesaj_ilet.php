         ...
         <td width="60%" valign="top"><form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
           <table width="100%" border="0" cellspacing="5" cellpadding="5">
             ...
             <tr>
               ...
               <td class="icyazi"><input name="konu" type="text" class="metinkutusu" id="konu" value="<?php echo "İlet: ".$row_m['konu']; ?>" size="55" maxlength="100" />
                 <span class="baslik">                 *</span></td>
             </tr>
             <tr>
               <td valign="top" class="icyazi"><div align="left"><strong>Mesaj</strong></div></td>
               <td valign="top" class="icyazi"><strong>:</strong></td>
               <td valign="top" class="icyazi"><label><span class="baslik">               
      <textarea name="icerik" cols="60" rows="7" class="metinkutusu" id="icerik">
