...
// language 
SpawConfig::setStaticConfigItem('default_lang','tr');
...
// height 
SpawConfig::setStaticConfigItem('default_height','175px');
...
SpawConfig::setStaticConfigItem(
  ...
  array(
    ...
    'max_img_width'       => 500,             // max uploaded image width allowed, or 0 to ignore
    'max_img_height'      => 800,             // max uploaded image height allowed, or 0 to ignore
