...
mysql_select_db($database_lmscon, $lmscon);
$query_nd = sprintf("SELECT *, DATE_FORMAT(nezaman, '%%d.%%m.%%Y') AS zaman, DATE_FORMAT(tarih, '%%d.%%m.%%Y - %%H:%%i') AS tarihsaat FROM lms_not_defteri WHERE kimlik = %s and no = %s", GetSQLValueString($bir_nd, "int"),GetSQLValueString($iki_nd, "int"));
...
<!-- fwtable fwsrc="lms_ic.png" fwpage="LMS ic" fwbase="lms_ic.gif" fwstyle="Dreamweaver" fwdocid = "52238024" fwnested="0" -->
  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="60%" class="baslik">Not Ayrıntı</td>
         <td width="40%" class="baslik">Ek Seçenekler</td>
       </tr>
       <tr>
         <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
           <tr>
             <td valign="top" nowrap="nowrap" class="icyazi"><strong>Not Girişi</strong></td>
             <td valign="top" class="icyazi"><strong>:</strong></td>
             <td width="84%" valign="top" class="icyazi"><?php echo $row_nd['tarihsaat']; ?></td>
           </tr>
           <tr>
             <td width="14%" valign="top" nowrap="nowrap" class="icyazi"><strong>Konu</strong></td>
             <td width="2%" valign="top" class="icyazi"><strong>:</strong></td>
             <td valign="top" class="icyazi"><label><?php echo $row_nd['konu']; ?></label></td>
           </tr>
           <tr>
             <td valign="top" nowrap="nowrap" class="icyazi"><strong>İçerik</strong></td>
             <td valign="top" class="icyazi"><strong>:</strong></td>
             <td valign="top" class="icyazi"><label><?php echo str_replace("\n","<br>", $row_nd['icerik']); ?></label></td>
           </tr>
           <tr>
             <td class="icyazi"><div align="right"><img src="simgeler/alarm_16.gif" alt="Alarm açık mı?" width="16" height="16" /></div></td>
             <td class="icyazi"><strong>:</strong></td>
             <td class="icyazi"><?php echo $row_nd['hatirlat']; ?></td>
             </tr>
           <tr>
             <td class="icyazi"><div align="right"><img src="simgeler/cal_16.gif" alt="Hatırlatma Tarihi" width="16" height="16" /></div></td>
             <td class="icyazi"><strong>:</strong></td>
             <td class="icyazi"><label><?php echo $row_nd['zaman']; ?></label></td>
           </tr>

         </table></td>
         <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
           <tr>
             <td width="5%"><a href="not_defteri_sil.php?<?php echo $MM_keepURL; ?>"><img src="simgeler/del_16.gif" alt="Sil" width="16" height="16" border="0" onclick="GP_popupConfirmMsg('Almış oldupunuz not sistemden tamamen silinecektir!');return document.MM_returnValue" /></a></td>
             <td width="95%"><a href="not_defteri_sil.php?<?php echo $MM_keepURL; ?>" class="icyazi">Haber - Duyuru - Etkinlik Sil</a></td>
           </tr>
           <tr>
             <td><a href="not_defteri_guncelle.php?<?php echo $MM_keepURL; ?>"><img src="simgeler/edit_16.gif" alt="Güncelle" width="16" height="16" border="0" /></a></td>
             <td><a href="not_defteri_guncelle.php?<?php echo $MM_keepURL; ?>" class="icyazi">Haber - Duyuru - Etkinlik Güncelle</a></td>
           </tr>
         </table></td>
       </tr>
     </table>
