...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE lms_not_defteri SET konu=%s, icerik=%s, hatirlat=%s, nezaman=%s WHERE `no`=%s",
...
mysql_select_db($database_lmscon, $lmscon);
$query_nd = sprintf("SELECT * FROM lms_not_defteri WHERE kimlik = %s and no = %s", GetSQLValueString($bir_nd, "int"),GetSQLValueString($iki_nd, "int"));
...
<!-- fwtable fwsrc="lms_ic.png" fwpage="LMS ic" fwbase="lms_ic.gif" fwstyle="Dreamweaver" fwdocid = "52238024" fwnested="0" -->
  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="60%" class="baslik">Yeni Not Al</td>
           ...
           <table width="100%" border="0" cellspacing="2" cellpadding="3">
             <tr>
               ...
               <td colspan="2" class="icyazi"><label>
                 <input name="konu" type="text" class="metinkutusu" id="konu" value="<?php echo $row_nd['konu']; ?>" size="55" />
             ...
             <tr>
               ...
               <td colspan="2" class="icyazi"><label>
                 <textarea name="icerik" cols="65" rows="6" class="metinkutusu" id="icerik"><?php echo $row_nd['icerik']; ?></textarea>
                 <span class="baslik">*</span></label></td>
             </tr>
             <tr>
               <td class="icyazi"><div align="right"><img src="simgeler/alarm_16.gif" width="16" height="16" /></div></td>
               <td class="icyazi"><strong>:</strong></td>
               <td width="5%" class="icyazi"><label>
                 <input <?php if (!(strcmp($row_nd['hatirlat'],"Evet"))) {echo "checked=\"checked\"";} ?> name="hatirlat" type="checkbox" class="icyazi" id="hatirlat" value="Evet" />
               </label></td>
               <td width="79%" class="icyazi">Aldığım notu bana hatırlat</td>
               </tr>
             <tr>
               <td class="icyazi"><div align="right"><img src="simgeler/cal_16.gif" width="16" height="16" /></div></td>
               <td class="icyazi"><strong>:</strong></td>
               <td colspan="2" class="icyazi"><label>
                 <input name="nezaman" type="text" class="metinkutusu" id="nezaman" onclick="GetDate(this);" value="<?php echo $row_nd['nezaman']; ?>" size="32" readonly="readonly" />
               </label></td>
               </tr>
             <tr>
               <td class="icyazi">&nbsp;</td>
               <td class="icyazi">&nbsp;</td>
               <td colspan="2" class="icyazi"><label>
                 <input name="button" type="submit" class="buton" id="button" onclick="YY_checkform('form1','konu','#q','0','Konu','icerik','1','1','İçerik');return document.MM_returnValue" value="Not Güncelle" />
