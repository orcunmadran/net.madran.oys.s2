...
if (isset($_GET['kimlik'])) {
  $deger_profil = $_GET['kimlik'];
}
mysql_select_db($database_lmscon, $lmscon);
$query_profil = sprintf("SELECT K.*, S.aciklama FROM lms_kullanici K, lms_seviye S WHERE K.kimlik = %s AND K.yetki = S.yetki", GetSQLValueString($deger_profil, "text"));
$profil = mysql_query($query_profil, $lmscon) or die(mysql_error());
   ...
   <td rowspan="2" class="ustbaslik"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         ...
         <td width="93%">Kullanıcı Profili Görüntüle</td>
       </tr>
     </table>
       ...
       <tr>
         <td width="60%" valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
           <tr>
             ...
             <td width="149" rowspan="5" align="center" valign="middle" bgcolor="#CCCCCC"><img src="avatar/<?php echo $row_profil['kimlik']; ?>.jpg" width="125" height="125" border="0" lowsrc="avatar/avatar.jpg" /></td>
           </tr>
           
           <tr>
             <td width="98" nowrap="nowrap" class="icyazi"><strong>Kullanıcı Adı</strong></td>
             <td width="4" class="icyazi"><strong>:</strong></td>
             <td width="224" class="icyazi"><?php echo $row_profil['kimlik']; ?></td>
           </tr>
           
           <tr>
             <td nowrap="nowrap" class="icyazi"><strong>Yetki Seviyesi</strong></td>
             <td class="icyazi"><strong>:</strong></td>
             <td class="icyazi"><?php echo $row_profil['aciklama']; ?></td>
             </tr>
           <tr>
             <td nowrap="nowrap" class="icyazi"><strong>Ad</strong></td>
             <td class="icyazi"><strong>:</strong></td>
             <td class="icyazi"><?php echo $row_profil['ad']; ?></td>
             </tr>
           <tr>
             <td nowrap="nowrap" class="icyazi"><strong>Soyad</strong></td>
             <td class="icyazi"><strong>:</strong></td>
             <td class="icyazi"><?php echo $row_profil['soyad']; ?></td>
             </tr>
           <tr>
             <td nowrap="nowrap" class="icyazi"><strong>E - Posta</strong></td>
             <td class="icyazi"><strong>:</strong></td>
             <td colspan="2" class="icyazi"><a href="mailto:<?php echo $row_profil['eposta']; ?>"><?php echo $row_profil['eposta']; ?></a></td>
             </tr>
           <tr>
             <td nowrap="nowrap" class="icyazi"><strong>Web</strong></td>
             <td class="icyazi"><strong>:</strong></td>
             <td colspan="2" class="icyazi"><a href="<?php echo $row_profil['web']; ?>" target="_blank"><?php echo $row_profil['web']; ?></a></td>
           </tr>
           <tr>
             <td colspan="4" nowrap="nowrap" class="icyazi"><hr size="1" /></td>
             </tr>
           <tr>
             <td colspan="2" nowrap="nowrap" class="icyazi"><div align="right"><img src="simgeler/mail_24.gif" alt="Yeni Mesaj" width="24" height="24" /></div></td>
             <td colspan="2" nowrap="nowrap" class="icyazi"><a href="profil_mesaj.php?<?php echo $MM_keepURL; ?>">Kullanıcıya yeni mesaj gönder</a></td>
             </tr>
         </table></td>
