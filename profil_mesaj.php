...
if (isset($_GET['kimlik'])) {
  $deger_adres = $_GET['kimlik'];
}
mysql_select_db($database_lmscon, $lmscon);
$query_adres = sprintf("SELECT kimlik, CONCAT(ad, ' ', soyad) AS adsoyad FROM lms_kullanici WHERE kimlik = %s", GetSQLValueString($deger_adres, "text"));
...
mysql_select_db($database_lmscon, $lmscon);
$query_ym = sprintf("SELECT M.no FROM lms_mesaj M WHERE M.alici LIKE %s AND M.silindi = 0 AND M.okundu = 0", GetSQLValueString("%" . $deger_ym . "%", "text"));
...
<!-- fwtable fwsrc="lms_ic.png" fwpage="LMS ic" fwbase="lms_ic.gif" fwstyle="Dreamweaver" fwdocid = "52238024" fwnested="0" -->
  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="75%" valign="top"><form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
           <table width="100%" border="0" cellspacing="5" cellpadding="5">
             ...
             <tr>
               ...
               <td valign="top" class="icyazi"><label></label>
<label class="icyazi"><?php echo $row_adres['adsoyad']; ?>
<input name="alici" type="hidden" id="alici" value="<?php echo $row_adres['kimlik']; ?>" />
</label></td>
               </tr>
             <tr>
               <td class="icyazi"><div align="left"><strong>Konu</strong></div></td>
               <td class="icyazi"><strong>:</strong></td>
               <td class="icyazi"><input name="konu" type="text" class="metinkutusu" id="konu" size="65" maxlength="100" />
             ...
             <tr>
               ...
               <td valign="top" class="icyazi"><label>
                 <textarea name="icerik" cols="80" rows="7" class="metinkutusu" id="icerik"></textarea>
             ...
             <tr>
               ...
               <td class="icyazi"><label>
                 <input name="button" type="submit" class="buton" id="button" onclick="YY_checkform('form1','konu','#q','0','Konu','icerik','1','1','Mesaj');return document.MM_returnValue" value="Gönder" />
               </label></td>
             </tr>
             <tr>
         ...
         <td width="25%" valign="top"><table width="70%" border="0" align="center" cellpadding="3" cellspacing="2">
           <tr>
             <td class="arabaslik"><div align="center"></div></td>
             <td class="arabaslik">Posta Kutusu</td>
           </tr>
           <tr>
             <td colspan="2"><hr size="1" /></td>
           </tr>
           <tr>
             <td width="10%"><img src="simgeler/mesaj/yeni.gif" alt="Yeni Mesaj Oluştur" width="16" height="15" /></td>
             <td nowrap="nowrap" class="icyazi"><a href="mesaj_gonder.php">Yeni Mesaj Oluştur</a></td>
           </tr>
           <tr>
             <td><img src="simgeler/mesaj/gelenler.gif" alt="Gelen Mesajlar" width="16" height="15" /></td>
             <td class="icyazi"><p><a href="mesajlar.php">Gelen Mesajlar </a>
           ...
           <tr>
             <td><img src="simgeler/mesaj/gonderilenler.gif" alt="Gönderilmiş Mesajlar" width="16" height="15" /></td>
             <td nowrap="nowrap" class="icyazi"><a href="mesaj_gonderilen.php">Gönderilmiş Mesajlar</a></td>
           </tr>
           <tr>
             <td colspan="2"><hr size="1" /></td>
           </tr>
           <tr>
             <td><img src="simgeler/mesaj/duyuru.gif" alt="Güncel Duyurular" width="16" height="15" /></td>
             <td nowrap="nowrap" class="icyazi"><a href="duyurular.php">Güncel Duyurular</a></td>
           </tr>
           <tr>
             <td><img src="simgeler/mesaj/arsiv.gif" alt="Güncel Duyurular" width="16" height="15" /></td>
             <td nowrap="nowrap" class="icyazi"><a href="duyurular_arsiv.php">Duyuru Arşivi</a></td>
           </tr>
         </table></td>
       </tr>
     </table>
