...
//toLog("phpfox_config",$phpfox_config);
...
$GLOBALS['fc_config']['db'] = array(
	'host' => $phpfox_config['mysql_host'],
	'user' => $phpfox_config['mysql_username'],
	'pass' => $phpfox_config['mysql_password'],
	'base' => $phpfox_config['mysql_table'],
	'pref' => 'fc_',
	);
