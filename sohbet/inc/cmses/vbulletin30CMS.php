...
$Author: pem $
$Revision: 1.10 $  
$Date: 2006/12/08 03:19:18 $ 

Version 1.21 
By Paul M - this CMS file is for integration with vBulletin 3.0

Recent changes ;
1.16 - Minor fix to Get User for membergroupids.
1.17 - Security (anti-hacking) code added (as supplied by Darren).
1.18 - Minor updates, user settings moved to top.
1.19 - Fixed bug in vbpath when in admin area.
1.20 - Default role changed.
1.21 - Minor bug fix to Avatar detection, login code changes, tidy up.
*/
...
$GLOBALS['vbulletin'] = array(
        'cookie' => $cookieprefix, 'prefix' => $tableprefix,
        'spkupdate' => false, 'logupdate' => false, 'useavatar' => true, 
		'users' => explode(',',$users), 'mods' => explode(',',$moderators), 
		'admin' => explode(',',$administrators), 'banned' => explode(',',$banned), 
