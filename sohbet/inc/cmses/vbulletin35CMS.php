...
$Author: pem $
$Revision: 1.3.6.11 $  
$Date: 2006/12/08 03:19:42 $ 

Version 2.67
By Paul M - this CMS file is for integration with vBulletin 3.5

Recent changes ;
2.62 - Minor fix to Get User for membergroupids.
2.63 - Security (anti-hacking) code added (as supplied by Darren).
2.64 - Minor updates, user settings moved to top.
2.65 - Fixed bug in vbpath when in admin area.
