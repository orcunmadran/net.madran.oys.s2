<?php
	...
	$GLOBALS['fc_config'] = array(
		...
		'loginUTF8decode' => true,// possible values - true, false
		...
		// Roles config
		'adminPassword' => '2',   //allows any user to login as a administrator - stateless CMS mode only
		'moderatorPassword' => '3', //allows any user to login as a moderator - stateless CMS mode only
		'spyPassword'   => '1',     //allows any user to login as a spy - stateless CMS mode only
		...
		'preloader' => array(
			'text' => array(
				'settings' => 'Ayarlar yukleniyor...',
				'smilies'  => 'Simgeler yukleniyor....',
				'mainchat' => 'Ana sohbet odasi yukleniyor...',
				'starting' => 'Sohbet sistemi baslatiliyor...',
				'okText'   => 'TAMAM'
			),
			'fontFamily' => 'Verdana',
			'fontSize'   => '11',
		...
		'allowLanguage' => false,    //allow user to choose another language
