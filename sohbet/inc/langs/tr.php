<?php
	$GLOBALS['fc_config']['languages']['tr'] = array(
		...
		'messages' => array(
			...
			'login' => 'Sohbete girmek için <a href="../index.php"><b>tıklayınız</b></a>',
			'required' => 'gerekli',
			...
			'roomlock' => 'Bu oda şifre korumalıdır.<br>Lütfen oda şifresini giriniz:',
			'locked' => 'Hatalı şifre. Lütfen yeniden deneyiniz.',
			'botfeat' => 'Bot fonksiyonu devrede değil.',
			'securityrisk' => 'Yüklemek istediğiniz dosya riskli bir içeriğe sahip. Lütfen başka bir dosya seçiniz.',
		),
		...
		'dialog' => array(
			...
			'createroom' => array(
				...
				'enterpass' => 'Oda için bir şifre belirleyiniz. Şifresiz giriş için boş bırakınız',
			),
