<?php
	...
	$FC_owner_email  = 'bote@baskent.edu.tr';	// FlashChat owner email address, set as sender/reply to in password change
	$FC_owner_name   = 'Egitim Yönetim Sistemi';	// FlashChat owner name (link text)
