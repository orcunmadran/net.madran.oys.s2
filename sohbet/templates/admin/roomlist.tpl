...
{foreach from=$rooms item=room}
			...
			<tr>
				...
				<!-- Name row -->
				<td align="center">
					<input type="button" value="edit" id="bttn_{$room.row_nr}" onclick="javascript: onbttnclick('bttn_{$room.row_nr}','room_name[{$room.row_nr}]');">
				...
				<!-- Password row -->
				<td align="center">
					<input type="button" value="edit" id="bttn_pass_{$room.row_nr}" onclick="javascript: onbttnclick('bttn_pass_{$room.row_nr}','room_password[{$room.row_nr}]');">
