...
$query_tanitim = sprintf("SELECT *, CONCAT(ad, ' ', soyad) AS adsoyad FROM lms_kullanici WHERE kimlik = %s", GetSQLValueString($colname_tanitim, "text"));
...
<!-- fwtable fwsrc="lms_ic.png" fwpage="LMS ic" fwbase="lms_ic.gif" fwstyle="Dreamweaver" fwdocid = "52238024" fwnested="0" -->
  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="60%" class="baslik">Sohbet Odaları Hakkında</td>
         <td width="40%" class="baslik">Sistem Gereksinimleri</td>
       </tr>
       <tr>
         <td valign="top"><p class="icyazi">Sohbet odaları, öğretim yönetim sistemi içinde yer alan kullanıcılar ile eş zamanlı (senkron) olarak mesajlaşabileceğiniz bir platformdur. Her dersin kendine ait sohbet odası olduğu gibi genel amaçlı sohbet odaları da (Kafeterya, Konferans, Teknik Destek) bulunmaktadır.</p>
          <p class="icyazi">Derse ait sohbet odaları ilgili dersin ders sorumlusu tarafından oluşturulur. Odaya girmek için istenen özel koda ilgili dersin anasayfasından ulaşılabilir.</p>
          <p class="icyazi">Tüm sohbet odalarında yapılan mesajlaşmalar kayıt altına alınmaktadır. Sohbet odalarındaki kullanıcıların genel ahlak kuralları çerçevesinde, diğer kullanıcıları rencide etmeyecek, dersin düzenini ve akışını bozmayacak şekilde davranması önemle rica olunur.</p>
          <p class="icyazi">İyi sohbetler...</p></td>
         <td rowspan="2" valign="top" class="icyazi"><p>Sohbet odalarına girebilmek için Adobe Flash Player eklentisinin ihtiyacınız bulunmaktadır.</p>
          <p>
            <script type="text/javascript">
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','350','height','100','src','swf/sohbet_kontrol','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','swf/sohbet_kontrol' ); //end AC code
            </script>
            <noscript>
            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="350" height="100">
              <param name="movie" value="swf/sohbet_kontrol.swf" />
              <param name="quality" value="high" />
              <embed src="swf/sohbet_kontrol.swf" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="350" height="100"></embed>
            </object>
            </noscript>
          </p>
          <p>Eğer yukarıdaki &quot;<strong>Flash Player Yüklü</strong>&quot; bilgi kutusunu göremiyorsanız ya da  sürümünüz güncel değilse lütfen ücretsiz Adobe Flash Player eklentisini aşağıdaki linkten yükleyiniz.</p>
          <p><a href="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash&amp;promoid=BIOW" target="_blank"><img src="resimler/get_flash_player.gif" alt="ADOBE FLASH PLAYER eklentisini indirmek için tıklayınız." width="88" height="31" border="0" /></a></p>
          </td>
       </tr>
       <tr>
         <td><form action="sohbet/flashchat.php" method="post" name="form1" target="_blank" id="form1">
           <input name="button" type="submit" class="buton" id="button" value="Sohbet odalarına ulaşmak için tıklayınız" />
           <input name="username" type="hidden" id="username" value="<?php echo $row_tanitim['adsoyad']; ?>" />
           <input name="password" type="hidden" id="password" value="<?php echo $row_tanitim['yetki']; ?>" />
                                    <label></label>
         </form>         </td>
        </tr>
     </table>
