...
*/
	function dynCalendar(objName, callbackFunc)
	{
        ...
        */
		...
		this.imagesPath     = arguments[2] ? arguments[2] : '../../dyncal/images/';
...
*/
	function dynCalendar_show()
	{
		...
		monthnames = new Array('Ocak', 'Þubat', 'Mart', 'Nisan', 'Mayýs', 'Haziran', 'Temmuz', 'Aðustos', 'Eylül', 'Ekim', 'Kasým', 'Aralýk');
        ...
        */
		...
		html += '<tr>';
		html += '<td class="dynCalendar_dayname">Pzr</td>';
		html += '<td class="dynCalendar_dayname">Pzt</td>';
		html += '<td class="dynCalendar_dayname">Sal</td>';
		html += '<td class="dynCalendar_dayname">Çar</td>';
		html += '<td class="dynCalendar_dayname">Per</td>';
		html += '<td class="dynCalendar_dayname">Cum</td>';
		html += '<td class="dynCalendar_dayname">Cts</td></tr>';
		html += '<tr>' + ret.join('</tr>\n<tr>') + '</tr>';
		html += '</table>';
