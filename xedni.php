  ...
  <tr>
   ...
   <td colspan="9" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="4%">&nbsp;</td>
         <td width="96%" class="arabaslik">Öğretim Yönetim Sisteminden güvenli olarak çıkış yaptınız.</td>
       </tr>
       <tr>
         <td>&nbsp;</td>
         <td><ul>
           <li class="icyazi">Yeniden Giriş yapmak için <a href="index.php">tıklayınız</a>.</li>
         </ul></td>
       </tr>
     </table>
   <!-- InstanceEndEditable --></td>
