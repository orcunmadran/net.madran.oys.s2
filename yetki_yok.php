  ...
  <tr>
   ...
   <td colspan="9" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="4%">&nbsp;</td>
         <td width="96%" class="arabaslik">Erişmek istediğiniz sayfaya giriş yetkiniz yok.</td>
       </tr>
       <tr>
         <td>&nbsp;</td>
         <td><ul>
           <li class="icyazi"> Sisteme giriş yapmak için <a href="index.php">tıklayınız</a>.</li>
         </ul></td>
       </tr>
     </table>
   <!-- InstanceEndEditable --></td>
