...
$query_tanitim = sprintf("SELECT K.*, S.aciklama FROM lms_kullanici K, lms_seviye S WHERE kimlik = %s AND K.yetki = S.yetki", GetSQLValueString($colname_tanitim, "text"));
     ...
     <table width="100%" border="0" cellspacing="1" cellpadding="1">
       <tr>
         <td width="60%" valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
           <tr>
             <td colspan="3" valign="bottom" class="baslik">Kişisel Bilgiler
               <div align="center"><strong></strong></div></td>
             <td width="149" rowspan="5" align="center" valign="middle" bgcolor="#CCCCCC"><img src="avatar/<?php echo $row_tanitim['kimlik']; ?>.jpg" width="125" height="125" border="0" lowsrc="avatar/avatar.jpg" /></td>
           </tr>
           
           <tr>
             <td width="98" nowrap="nowrap" class="icyazi"><strong>Kullanıcı Adı</strong></td>
             <td width="4" class="icyazi"><strong>:</strong></td>
             <td width="224" class="icyazi"><?php echo $row_tanitim['kimlik']; ?></td>
             </tr>
           <tr>
             <td nowrap="nowrap" class="icyazi"><strong>Yetki Seviyesi</strong></td>
             <td class="icyazi"><strong>:</strong></td>
             <td class="icyazi"><?php echo $row_tanitim['yetki']; ?> - <?php echo $row_tanitim['aciklama']; ?></td>
             </tr>
           <tr>
             <td nowrap="nowrap" class="icyazi"><strong>Ad</strong></td>
             <td class="icyazi"><strong>:</strong></td>
             <td class="icyazi"><?php echo $row_tanitim['ad']; ?></td>
             </tr>
           <tr>
             <td nowrap="nowrap" class="icyazi"><strong>Soyad</strong></td>
             <td class="icyazi"><strong>:</strong></td>
             <td class="icyazi"><?php echo $row_tanitim['soyad']; ?></td>
             </tr>
           <tr>
             <td nowrap="nowrap" class="icyazi"><strong>E - Posta</strong></td>
             <td class="icyazi"><strong>:</strong></td>
             <td colspan="2" class="icyazi"><a href="mailto:<?php echo $row_tanitim['eposta']; ?>"><?php echo $row_tanitim['eposta']; ?></a></td>
             </tr>
           <tr>
             <td nowrap="nowrap" class="icyazi"><strong>Web</strong></td>
             <td class="icyazi"><strong>:</strong></td>
             <td colspan="2" class="icyazi"><a href="<?php echo $row_tanitim['web']; ?>" target="_blank"><?php echo $row_tanitim['web']; ?></a></td>
           </tr>
           <tr>
             <td colspan="3" class="baslik"><hr size="1" /></td>
             <td class="baslik">&nbsp;</td>
           </tr>
           <tr>
             <td colspan="4" class="baslik"><table width="100%" border="0" cellspacing="2" cellpadding="3">
               <tr>
                 <td width="6%"><span class="arabaslik"><a href="yonetim_kbg.php"><img src="simgeler/addbk_24.gif" width="24" height="24" border="0" /></a></span></td>
                 <td width="94%"><span class="arabaslik"><a href="yonetim_kbg.php">Kişisel Bilgileri Güncelle</a></span></td>
               </tr>
               <tr>
                 <td><a href="yonetim_sd.php"><img src="simgeler/lock_24.gif" width="24" height="24" border="0" /></a></td>
                 <td><span class="arabaslik"><a href="yonetim_sd.php">Şifre Değiştir</a></span></td>
               </tr>
               <tr>
                 <td height="30"><a href="yonetim_ayg.php"><img src="simgeler/image_24.gif" width="24" height="24" border="0" /></a></td>
                 <td><span class="arabaslik"><a href="yonetim_ayg.php">Görüntü Resmi (Avatar) Yükle / Güncelle</a></span></td>
               </tr>
             </table></td>
           </tr>
         </table></td>
         ...
         <table width="80%" border="0" align="center" cellpadding="5" cellspacing="5" id="yonetici">
           <tr>
             <td colspan="2"><div align="center" class="baslik">
               <div align="left">Yönetici İşlemleri (İdari)</div>
             </div></td>
           </tr>
           <tr>
             <td width="4%"><a href="yonetim_kullanici.php"><img src="simgeler/user_24.gif" alt="Kullanıcı İşlemleri" width="24" height="24" border="0" /></a></td>
             <td width="96%" class="arabaslik">Kullanıcılar</td>
           </tr>
           <tr>
             <td><a href="yonetim_duyurular.php"><img src="simgeler/new_24.gif" alt="Haber - Duyuru - Etkinlik" width="24" height="24" border="0" /></a></td>
             <td class="arabaslik">Genel Duyuru - Haber - Etkinlik</td>
           </tr>
         </table>
         <?php };?>
		 <?php if($row_tanitim['yetki'] < 3){?>
         <table width="80%" border="0" align="center" cellpadding="5" cellspacing="5" id="yonetici">
           <tr>
             <td colspan="2"><div align="center" class="baslik">
               <div align="left">Yönetici İşlemleri (Akademik)</div>
             </div></td>
           </tr>
           <tr>
             <td width="4%"><a href="yonetim_dersler.php"><img src="simgeler/hist_24.gif" alt="Ders İşlemleri" width="24" height="24" border="0" /></a></td>
             <td width="96%" class="arabaslik">Dersler</td>
           </tr>
           <tr>
             <td><a href="yonetim_subeler.php"><img src="simgeler/ntwrk_24.gif" alt="Şube İşlemleri" width="24" height="24" border="0" /></a></td>
             <td class="arabaslik">Şubeler</td>
           </tr>
           <tr>
             <td><a href="yonetim_duyurular.php"><img src="simgeler/new_24.gif" alt="Haber - Duyuru - Etkinlik" width="24" height="24" border="0" /></a></td>
             <td class="arabaslik">Ders Duyuruları</td>
           </tr>
         </table>
         <?php };?>
         ...
         <table width="80%" border="0" align="center" cellpadding="5" cellspacing="5" id="yonetici">
           <tr>
             <td colspan="2"><div align="center" class="baslik">
               <div align="left">Öğretim Elemanı İşlemleri</div>
             </div></td>
           </tr>
           <tr>
             <td width="4%"><a href="forumlar.php"><img src="simgeler/docs_24.gif" alt="Tartışma Grupları" width="24" height="24" border="0" /></a></td>
             <td width="96%" class="arabaslik">Tartışma Grupları</td>
           </tr>
           <tr>
             <td><a href="yonetim_sube_sohbet.php"><img src="simgeler/group_24.gif" alt="Sohbet Odaları" width="24" height="24" border="0" /></a></td>
             <td class="arabaslik">Sohbet Odaları</td>
           </tr>
           <tr>
             <td><a href="yonetim_sube_duyurular.php"><img src="simgeler/new_24.gif" alt="Haber - Duyuru - Etkinlik" width="24" height="24" border="0" /></a></td>
             <td class="arabaslik">Şube Duyuruları</td>
           </tr>
         </table>
         <?php };?>
         </td>
