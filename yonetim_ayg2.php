...
if(in_array($dosyauzantisi, $izinverilen)){
	...
	// Yükleme İşlemi
		if(is_uploaded_file($_FILES['dosya']['tmp_name'])){
			move_uploaded_file($_FILES['dosya']['tmp_name'], "avatar/".$row_tanitim['kimlik'].".jpg");
			$avatarbilgi = 0;
			}
				else{
				$yuklemehata =  "Yükleme işlemi gerçekleştirilemedi.<br>";
				$avatarbilgi = 1;
				}
}
else{
	$boyutkontrol = "Dosya büyüklüğü maksimum değerin üzerinde.";
	$avatarbilgi  = 1;
		}
		}
	else{
		$uzantikontrol = "Yüklemek istediğiniz dosya uzantısı geçerli değil.";
		$avatarbilgi  = 1;
		}
?>
<?php
  ...
  <tr>
   ...
   <td rowspan="2" class="ustbaslik"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="7%"><a href="yonetim_ayg.php"><img src="simgeler/back_24.gif" alt="Avatar Yükleme / Güncelleme Paneline geri dön" width="24" height="24" border="0" /></a></td>
  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="60%">
         <?php if ($avatarbilgi == 0) { ?>
         </p>
           <p class="icyazi">İşlem gerçekleştiriliyor... <meta http-equiv="Refresh" content="1;URL=yonetim.php"/></p>
           <p>
             <?php } ?>
</p>
           <p>
             <?php if ($avatarbilgi == 1) { ?>
            </p>
           <p><span class="arabaslik">Yükleme işlemi sırasında hata / hatalarla karşılaşıldı:</span></p>
           <p class="icyazi"><?php echo $uzantikontrol;?><?php echo $boyutkontrol;?><?php echo $yuklemehata;?></p>
           <p class="icyazi"><?php echo $hatabir;?><?php echo $hataiki;?><?php echo $hatauc;?><?php echo $hatadort;?></p>
           <p class="icyazi">Yükleme sayfasına geri dönmek için <a href="yonetim_ayg.php">tıklayınız</a>. </p>
           <p>
            <?php } ?>
         </td>
         <td valign="top">&nbsp;</td>
