...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE lms_cevrimici SET dersno=%s, baslik=%s, adres=%s, eklenti=%s WHERE `no`=%s",
  ...
  $updateGoTo = "yonetim_ders_cevrimici.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_cev = "-1";
if (isset($_GET['cevno'])) {
  $colname_cev = $_GET['cevno'];
}
mysql_select_db($database_lmscon, $lmscon);
$query_cev = sprintf("SELECT * FROM lms_cevrimici WHERE no = %s", GetSQLValueString($colname_cev, "int"));
...
<!-- fwtable fwsrc="lms_ic.png" fwpage="LMS ic" fwbase="lms_ic.gif" fwstyle="Dreamweaver" fwdocid = "52238024" fwnested="0" -->
  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="50%" valign="top"><form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
           <table width="100%" border="0" cellspacing="5" cellpadding="5">
             <tr>
               <td colspan="3" class="baslik">Çevrimiçi Kaynak Güncelle</td>
             </tr>
             <tr>
             ...
             <tr>
               ...
               <td width="83%"><label>
                 <input name="baslik" type="text" class="metinkutusu" id="baslik" value="<?php echo $row_cev['baslik']; ?>" size="30" maxlength="255" />
                 <span class="baslik">*</span></label></td>
             </tr>
             <tr>
               <td class="icyazi"><strong>Adres</strong></td>
               <td class="icyazi"><strong>:</strong></td>
               <td><input name="adres" type="text" class="metinkutusu" id="adres" value="<?php echo $row_cev['adres']; ?>" size="45" maxlength="255" />
                 <span class="baslik">*</span></td>
             </tr>
             <tr>
               <td colspan="2" class="icyazi"><input name="no" type="hidden" id="no" value="<?php echo $row_cev['no']; ?>" />
                 <input name="dersno" type="hidden" id="dersno" value="<?php echo $row_ders['no']; ?>" />
                 <input name="eklenti" type="hidden" id="eklenti" value="<?php echo date("d.m.Y - H:i");?>" /></td>
               <td><label>
                 <input name="button" type="submit" class="buton" id="button" onclick="YY_checkform('form1','baslik','#q','0','Başlık','adres','#q','0','Adres');return document.MM_returnValue" value="Çevrimiçi Kaynak Güncelle" />
               </label></td>
             </tr>
             <tr>
