...
<!-- fwtable fwsrc="lms_ic.png" fwpage="LMS ic" fwbase="lms_ic.gif" fwstyle="Dreamweaver" fwdocid = "52238024" fwnested="0" -->
  ...
  <tr>
   ...
   <td rowspan="2" class="ustbaslik"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="7%"><a href="javascript:history.back()"><img src="simgeler/back_24.gif" alt="Çevrimiçi kaynaklara geri dönmek için tıklayınız." width="24" height="24" border="0" /></a></td>
  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="4%"><img src="simgeler/stop_24.gif" width="24" height="24" /></td>
         <td width="96%" class="baslik">Sistem Mesajı</td>
       </tr>
       <tr>
         <td>&nbsp;</td>
         <td class="arabaslik">Tanımlamış olduğunuz adres daha önce eklenmişti.</td>
       </tr>
       <tr>
         <td>&nbsp;</td>
         <td class="icyazi"> Yeni bir çevrimiçi kaynak eklemek için <a href="javascript:history.back()">tıklayınız</a>.</td>
       </tr>
     </table>
   <!-- InstanceEndEditable --></td>
