...
$colname_dok = "-1";
if (isset($_GET['dersno'])) {
  $colname_dok = $_GET['dersno'];
}
mysql_select_db($database_lmscon, $lmscon);
$query_dok = sprintf("SELECT * FROM lms_dokuman WHERE dersno = %s ORDER BY orjinalad", GetSQLValueString($colname_dok, "int"));
  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="1" cellpadding="1">
       <tr>
         <td width="60%" valign="top"><form action="yonetim_ders_dokuman2.php" method="POST" enctype="multipart/form-data" name="form1" id="form1">
           <table width="500" border="0" cellpadding="3" cellspacing="2">
             <tr>
               <td colspan="3" class="baslik">Doküman Yükle / Güncelle</td>
               </tr>
             <tr>
           ...
           <table width="500" border="0" cellpadding="3" cellspacing="2">
             <tr>
               ...
               <td width="97%"><p class="icyazi">Dosya adı, sistem içerisinde doküman adı olarak kullanılacaktır.</p>                  </td>
             </tr>
             <tr>
               <td valign="top"><span class="baslikMAVI">*</span></td>
               <td valign="top" class="icyazi">Yüklemiş olduğunuz bir dokümanı güncellemek için dosyayı yeniden yüklemeniz yeterli olacaktır.</td>
             </tr>
             <tr>
         ...
         <td width="49%" valign="top"><table width="100%" border="0" align="right" cellpadding="3" cellspacing="2">
           <tr>
             <td colspan="3"><span class="baslik"><?php echo $row_ders['kod']; ?> - Yüklü Olan Dokümanlar</span></td>
             </tr>
           <tr>
             <td colspan="3"><hr size="1" /></td>
             </tr>
           <?php if ($totalRows_dok == 0) { ?>
             <tr>
               <td colspan="3" class="icyazi">Sistemde bu ders için yüklü doküman bulunmamaktadır.</td>
             </tr>
             <?php } ?>
				<?php if ($totalRows_dok > 0) { ?>
             <tr>
             <td width="61%" class="arabaslik">Doküman</td>
             <td width="33%" nowrap="nowrap" class="arabaslik">Son Güncelleme</td>
             <td width="6%" class="arabaslik">&nbsp;</td>
             </tr>
             <?php do { ?>
               <tr>
                 <td valign="top" class="icyazi"><a href="dokumanlar/<?php echo $row_dok['dersno']; ?>_<?php echo $row_dok['dosyaadi']; ?>" target="_blank"><?php echo $row_dok['orjinalad']; ?></a></td>
                 <td valign="top" class="icyazi"><?php echo $row_dok['guncelleme']; ?></td>
                 <td valign="top" class="icyazi"><a href="yonetim_ders_dokuman_sil.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."dokumanno=".$row_dok['no'] ?>"><img src="simgeler/del_16.gif" alt="Sil" width="16" height="16" border="0" onclick="GP_popupConfirmMsg('Doküman sistemden kalıcı olarak silinecektir!');return document.MM_returnValue" /></a></td>
               </tr>
