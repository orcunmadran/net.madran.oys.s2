...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE lms_ders SET kod=%s, ad=%s, tanim=%s, izlence=%s, aktif=%s, kimlik=%s, etkilesim=%s WHERE `no`=%s",
  ...
  $updateGoTo = "yonetim_ders_islem_ok.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_lmscon, $lmscon);
$query_d = sprintf("SELECT * FROM lms_ders WHERE kimlik = %s AND no = %s", GetSQLValueString($colname_d, "text"),GetSQLValueString($deger_d, "int"));
...
$izlence = new SpawEditor("izlence", $row_d['izlence']);
?>
...
<!-- fwtable fwsrc="lms_ic.png" fwpage="LMS ic" fwbase="lms_ic.gif" fwstyle="Dreamweaver" fwdocid = "52238024" fwnested="0" -->
  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="1" cellpadding="1">
       <tr>
         <td width="60%"><form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
           <table width="100%" border="0" cellspacing="2" cellpadding="3">
             <tr>
               <td colspan="6" class="baslik">Ders Bilgilerini Güncelle</td>
             </tr>
             <tr>
               <td colspan="6" class="icyazi"><hr size="1" /></td>
             </tr>
             <tr>
               <td width="18%" nowrap="nowrap" class="icyazi"><strong>Dersin Kodu</strong></td>
               <td width="2%" class="icyazi"><strong>:</strong></td>
               <td colspan="4"><label class="icyazi">
               <input name="kod" type="text" class="metinkutusu" id="kod" value="<?php echo $row_d['kod']; ?>" size="20" maxlength="20" />
             ...
             <tr>
               ...
               <td colspan="4">
                 ...
                 <input name="ad" type="text" class="metinkutusu" id="ad" value="<?php echo $row_d['ad']; ?>" size="40" maxlength="255" /> 
             ...
             <tr>
               ...
               <td colspan="4"><label>
                 <textarea name="tanim" cols="45" rows="5" class="metinkutusu" id="tanim"><?php echo $row_d['tanim']; ?></textarea>
                 <span class="baslik">*</span></label></td>
             </tr>
             <tr>
               ...
               <td width="23%"><label>
                 <select name="aktif" class="metinkutusu" id="aktif">
                   <option value="<?php echo $row_d['aktif']; ?>" selected="selected"><?php echo $row_d['aktif']; ?></option>
                   <option value="-----">-----</option>
                   <option value="EVET">EVET</option>
                   <option value="HAYIR">HAYIR</option>
                                                                                                      </select>
                 <span class="baslik">*</span></label></td>
               <td width="13%"><strong class="icyazi">Etkileşim</strong></td>
               <td width="2%" class="icyazi"><strong>:</strong></td>
               <td width="42%"><select name="etkilesim" class="metinkutusu" id="etkilesim">
                 <option value="<?php echo $row_d['etkilesim']; ?>" selected="selected"><?php echo $row_d['etkilesim']; ?></option>
                 <option value="-----">-----</option>
                   <option value="EVET">EVET</option>
                   <option value="HAYIR">HAYIR</option>
                                               </select>
  ...
  $izlence->show();
  ?>
                 <input name="no" type="hidden" id="no" value="<?php echo $row_d['no']; ?>" />
                 <input name="kimlik" type="hidden" id="kimlik" value="<?php echo $row_tanitim['kimlik']; ?>" /></td>
             </tr>
             <tr>
               <td colspan="6" class="icyazi"><label>
                 <input name="button" type="submit" class="buton" id="button" onclick="YY_checkform('form1','kod','#q','0','Dersin Kodu','ad','#q','0','Dersin Adı','tanim','1','1','Kısa Tanım');return document.MM_returnValue" value="Ders Bilgilerini Güncelle" />
               </label></td>
               </tr>
           </table>
         ...
         <td valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="3">
           ...
           <tr>
             <td><div align="center"><a href="yonetim_dersler.php" class="icyazi">Ders işlemleri paneline geri dön</a></div></td>
           </tr>
           <tr>
