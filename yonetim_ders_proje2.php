...
if (isset($_POST[$MM_flag])) {
  $MM_dupKeyRedirect="yonetim_ders_proje.php";
  $loginUsername = $_POST['kontrol'];
  $LoginRS__query = sprintf("SELECT kontrol FROM lms_proje WHERE kontrol=%s", GetSQLValueString($loginUsername, "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO lms_proje (dersno, dosyaadi, orjinalad, guncelleme, kontrol, teslim) VALUES (%s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "yonetim_ders_proje.php?dersno=".$_SESSION['dersno'];
  if (isset($_SERVER['QUERY_STRING'])) {
...
// Yükleme İşlemi
	...
	if(is_uploaded_file($_FILES['dosya']['tmp_name'])){
		move_uploaded_file($_FILES['dosya']['tmp_name'], "projeler/".$_SESSION['dersno']."_".$dosyaadi);
  ...
  <tr>
   ...
   <td rowspan="2" class="ustbaslik"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="7%"><a href="yonetim_ders_proje.php?dersno=<?php echo $_SESSION['dersno']; ?>"><img src="simgeler/back_24.gif" alt="Geri dön" width="24" height="24" border="0" /></a></td>
...
<input type="hidden" name="MM_insert" value="form1" />
             ...
             <input name="teslim" type="hidden" id="teslim" value="<?php echo $_POST['teslim'];?>" />
             </form>             </td>
           </tr>
         </table>
         <?php } ?>
         <?php if ($yuklendi == 0) { ?>
           <table width="100%"  border="0" cellspacing="5" cellpadding="5">
             ...
             <tr>
               <td class="icyazi">&nbsp;</td>
               <td class="icyazi">Yükleme sayfasına geri dönmek için <a href="yonetim_ders_proje.php?dersno=<?php echo $_SESSION['dersno']; ?>">tıklayınız</a>.</td>
             </tr>
           </table>
           <?php } ?>
          </td>
