...
if (isset($_POST[$MM_flag])) {
  $MM_dupKeyRedirect="yonetim_dersler_hata.php";
  $loginUsername = $_POST['kod'];
  $LoginRS__query = sprintf("SELECT kod FROM lms_ders WHERE kod=%s", GetSQLValueString($loginUsername, "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO lms_ders (kod, ad, tanim, izlence, aktif, kimlik, etkilesim) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['kod'], "text"),
                       GetSQLValueString($_POST['ad'], "text"),
                       GetSQLValueString($_POST['tanim'], "text"),
                       GetSQLValueString($_POST['izlence'], "text"),
                       GetSQLValueString($_POST['aktif'], "text"),
                       GetSQLValueString($_POST['kimlik'], "text"),
					   GetSQLValueString($_POST['etkilesim'], "text"));

  mysql_select_db($database_lmscon, $lmscon);
  $Result1 = mysql_query($insertSQL, $lmscon) or die(mysql_error());

  $insertGoTo = "yonetim_dersler.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_d = "-1";
if (isset($_SESSION['MM_Username'])) {
  $colname_d = $_SESSION['MM_Username'];
}
mysql_select_db($database_lmscon, $lmscon);
$query_d = sprintf("SELECT * FROM lms_ders WHERE kimlik = %s ORDER BY no DESC", GetSQLValueString($colname_d, "text"));
$d = mysql_query($query_d, $lmscon) or die(mysql_error());
...
$izlence = new SpawEditor("izlence");
?>
  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="1" cellpadding="1">
       <tr>
         <td width="60%"><form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
           <table width="100%" border="0" cellspacing="2" cellpadding="3">
             <tr>
               <td colspan="6" class="baslik">Yeni Ders Ekle</td>
             </tr>
             <tr>
               <td colspan="6" class="icyazi"><hr size="1" /></td>
             </tr>
             <tr>
               <td width="17%" nowrap="nowrap" class="icyazi"><strong>Dersin Kodu</strong></td>
               <td width="2%" class="icyazi"><strong>:</strong></td>
               <td colspan="4"><label>
               <input name="kod" type="text" class="metinkutusu" id="kod" size="20" maxlength="20" />
               <span class="baslik">*</span></label></td>
             </tr>
             <tr>
               <td nowrap="nowrap" class="icyazi"><strong>Dersin Adı</strong></td>
               <td class="icyazi"><strong>:</strong></td>
               <td colspan="4">
                 <label></label>
               
                 <input name="ad" type="text" class="metinkutusu" id="ad" size="40" maxlength="255" /> 
                 <span class="baslik">*</span></td>
             </tr>
             <tr>
               <td valign="top" nowrap="nowrap" class="icyazi"><strong>Kısa Tanım</strong></td>
               <td valign="top" class="icyazi"><strong>:</strong></td>
               <td colspan="4"><label>
                 <textarea name="tanim" cols="45" rows="5" class="metinkutusu" id="tanim"></textarea>
                 <span class="baslik">*</span></label></td>
             </tr>
             <tr>
               <td nowrap="nowrap" class="icyazi"><strong>Aktif</strong></td>
               <td class="icyazi"><strong>:</strong></td>
               <td width="24%"><label>
                 <select name="aktif" class="metinkutusu" id="aktif">
                   <option selected="selected">Seçiniz</option>
                   <option value="EVET">EVET</option>
                   <option value="HAYIR">HAYIR</option>
                                                                    </select>
                 <span class="baslik">*</span></label></td>
               <td width="14%"><strong class="icyazi">Etkileşim</strong></td>
               <td width="2%" class="icyazi"><strong>:</strong></td>
               <td><select name="etkilesim" class="metinkutusu" id="etkilesim">
                 <option selected="selected">Seçiniz</option>
                 <option value="EVET">EVET</option>
                 <option value="HAYIR">HAYIR</option>
               </select>
             ...
             <tr>
               ...
               <td colspan="4" class="icyazi">Doldurulması zorunlu alanlar</td>
             </tr>
             <tr>
               <td colspan="6" class="arabaslik">Ders İzlencesi</td>
               </tr>
             <tr>
               <td colspan="6" class="icyazi"><?php
  $izlence->show();
  ?>
                 <input name="kimlik" type="hidden" id="kimlik" value="<?php echo $row_tanitim['kimlik']; ?>" /></td>
             </tr>
             <tr>
               <td colspan="6" class="icyazi"><label>
                 <input name="button" type="submit" class="buton" id="button" onclick="YY_checkform('form1','kod','#q','0','Dersin Kodu','ad','#q','0','Dersin Adı','aktif','#q','1','Ders Aktif Bilgisi','etkilesim','#q','1','Etkileşim','tanim','1','1','Kısa Tanım');return document.MM_returnValue" value="Yeni Ders Ekle" />
               </label></td>
               </tr>
           </table>
         ...
         <td valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="3">
           <tr>
             <td colspan="8" class="baslik">Sistemde Yer Alan Dersleriniz</td>
             </tr>
           <tr>
             <td colspan="8"><hr size="1" /></td>
             </tr>
            <?php if ($totalRows_d == 0) {?>
           <tr>
             <td colspan="8" class="icyazi">Sistem içerisinde daha önce oluşturmuş olduğunuz bir ders bulunmamaktadır. Sol tarafta yer alan &quot;Yeni Ders Ekle&quot; bölümünden sisteme yeni bir ders ekleyebilirsiniz.</td>
           </tr>
           <?php };?>
			<?php if ($totalRows_d > 0) {?>
<tr>
             <td width="14%" class="icyazi"><div align="right"><strong>No</strong></div></td>
             <td width="52%" class="icyazi"><strong>Ders Kodu</strong></td>
             <td colspan="2" class="icyazi"><p align="center">&nbsp;</p>               </td>
             <td class="icyazi">&nbsp;</td>
             <td colspan="3" class="arabaslik"><div align="center">Eğitim</div></td>
             </tr>
               <?php do { ?>
                  <tr>
                    <td width="14%" class="icyazi"><div align="right"><?php echo $row_d['no']; ?></div></td>
                    <td class="icyazi"><a href="ders_yonetici.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."dersno=".$row_d['no'] ?>"><?php echo $row_d['kod']; ?></a></td>
                    <td width="7%" class="icyazi"><a href="yonetim_ders_sil.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."no=".$row_d['no'] ?>"><img src="simgeler/del_16.gif" title="Sil" width="16" height="16" border="0" onclick="GP_popupConfirmMsg('Ders kalıcı olarak sistemden silinecektir!');return document.MM_returnValue" /></a></td>
                    <td width="7%" class="icyazi"><a href="yonetim_ders_guncelle.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."no=".$row_d['no'] ?>"><img src="simgeler/edit_16.gif" title="Güncelle" width="16" height="16" border="0" /></a></td>
                    <td width="3%" class="icyazi">-</td>
                    <td width="4%" class="icyazi"><a href="yonetim_ders_dokuman.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."dersno=".$row_d['no'] ?>"><img src="simgeler/copy_16.gif" title="Kaynak Dokümanlar" width="16" height="16" border="0" /></a></td>
                    <td width="7%" class="icyazi"><a href="yonetim_ders_cevrimici.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."dersno=".$row_d['no'] ?>"><img src="simgeler/web_16.gif" title="Çevrimiçi Kaynaklar;" width="16" height="16" border="0" /></a></td>
                    <td width="7%" class="icyazi"><a href="yonetim_ders_proje.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."dersno=".$row_d['no'] ?>"><img src="simgeler/adfav_16.gif" title="Ödevler / Projeler" width="16" height="16" border="0" /></a></td>
                </tr>
                  <?php } while ($row_d = mysql_fetch_assoc($d)); ?>
                  <?php };?>
         </table></td>
       </tr>
     </table>
