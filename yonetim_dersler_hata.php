  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       ...
       <tr>
         <td>&nbsp;</td>
         <td class="arabaslik">Belirlemiş olduğunuz ders kodu ile daha önce bir ders açılmıştır.</td>
       </tr>
       <tr>
         <td>&nbsp;</td>
         <td class="icyazi">Başka bir ders kodu ile yeni bir ders açmak için <a href="javascript:history.back()">tıklayınız</a>.</td>
       </tr>
     </table>
   <!-- InstanceEndEditable --></td>
