...
mysql_select_db($database_lmscon, $lmscon);
$query_duyuru = sprintf("SELECT DU.*, CONCAT(DATE_FORMAT(DU.baslama, '%%d.%%m.%%Y'), ' - ', DATE_FORMAT(DU.bitis, '%%d.%%m.%%Y')) AS tarih FROM lms_duyuru DU WHERE DU.kimlik = %s AND DU.no = %s", GetSQLValueString($bir_duyuru, "text"),GetSQLValueString($iki_duyuru, "int"));
...
<!-- fwtable fwsrc="lms_ic.png" fwpage="LMS ic" fwbase="lms_ic.gif" fwstyle="Dreamweaver" fwdocid = "52238024" fwnested="0" -->
  ...
  <tr>
   ...
   <td rowspan="2" class="ustbaslik"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="7%"><a href="yonetim_duyurular.php"><img src="simgeler/back_24.gif" alt="Geri dön" width="24" height="24" border="0" /></a></td>
         <td width="93%">Haber - Duyuru - Etkinlik Görüntüle</td>
       </tr>
     </table>
  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td class="baslik"><p><?php echo $row_duyuru['hedef']; ?></p>          </td>
         <td width="40%" class="baslik">Ek Seçenekler</td>
       </tr>
       <tr>
         <td><table width="100%" border="1" cellpadding="5" cellspacing="5" bordercolor="#CCCCCC" bgcolor="#FFFFFF">
             <tr>
               <td colspan="5" bordercolor="#FFFFFF"><p class="arabaslik"><?php echo $row_duyuru['baslik']; ?></p>
                 <p class="icyazi"><?php echo $row_duyuru['tarih']; ?></p>
                 <p class="icyazi"><?php echo $row_duyuru['icerik']; ?></p></td>
              </tr>
           
                  </table></td>
         <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
           <tr>
             <td width="5%"><a href="yonetim_duyuru_sil.php?<?php echo $MM_keepURL; ?>"><img src="simgeler/del_24.gif" alt="Sil" width="24" height="24" border="0" onclick="GP_popupConfirmMsg('Haber - Duyuru - Etkinlik sistemden tamamen silinecektir!');return document.MM_returnValue" /></a></td>
             <td width="95%" class="arabaslik">Haber - Duyuru - Etkinlik Sil</td>
           </tr>
           <tr>
             <td><a href="yonetim_duyuru_guncelle.php?<?php echo $MM_keepURL; ?>"><img src="simgeler/edit_24.gif" alt="G&uuml;ncelle" width="24" height="24" border="0" /></a></td>
             <td><span class="arabaslik">Haber - Duyuru - Etkinlik Güncelle</span></td>
           </tr>
         </table></td>
       </tr>
     </table>
