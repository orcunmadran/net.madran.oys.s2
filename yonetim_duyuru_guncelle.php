...
<!-- fwtable fwsrc="lms_ic.png" fwpage="LMS ic" fwbase="lms_ic.gif" fwstyle="Dreamweaver" fwdocid = "52238024" fwnested="0" -->
  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="60%" class="baslik">Haber - Duyuru - Etkinlik Güncelle</td>
  ...
  ?>
             ...
             <tr>
               <td colspan="3" class="icyazi"><label>
                 <input name="button" type="submit" class="buton" id="button" onclick="YY_checkform('form1','baslik','#q','0','Başlık','baslama','#q','0','Yayın Tarihi','bitis','#q','0','Yayın Bitiş Tarihi','kimlik','#q','0','Kullanıcı Adı');return document.MM_returnValue" value="Haber - Duyuru - Etkinlik Güncelle" />
               </label></td>
             </tr>
           </table>
