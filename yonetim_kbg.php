...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE lms_kullanici SET eposta=%s, web=%s WHERE kimlik=%s",
   ...
   <td rowspan="2" class="ustbaslik"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         ...
         <td width="93%">Kişisel Bilgileri Güncelle</td>
       </tr>
     </table>
       ...
       <tr>
         <td width="60%"><form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
           <table width="100%" border="0" cellspacing="2" cellpadding="3">
             <tr>
               <td width="15%" class="icyazi"><strong>Ad</strong></td>
               <td width="2%" class="icyazi"><strong>:</strong></td>
               <td width="83%"><label><span class="icyazi"><?php echo $row_tanitim['ad']; ?></span></label></td>
             </tr>
             <tr>
               <td class="icyazi"><strong>Soyad</strong></td>
               <td class="icyazi"><strong>:</strong></td>
               <td><label><span class="icyazi"><?php echo $row_tanitim['soyad']; ?></span></label></td>
             </tr>
             <tr>
               <td class="icyazi"><strong>E - Posta</strong></td>
               <td class="icyazi"><strong>:</strong></td>
               <td><label>
               <input name="eposta" type="text" class="metinkutusu" id="eposta" value="<?php echo $row_tanitim['eposta']; ?>" size="30" />
               <span class="baslik">*</span></label></td>
             </tr>
             <tr>
               <td class="icyazi"><strong>Web</strong></td>
               <td class="icyazi"><strong>:</strong></td>
               <td><label>
               <input name="web" type="text" class="metinkutusu" id="web" value="<?php echo $row_tanitim['web']; ?>" size="50" />
               </label></td>
             </tr>
             <tr>
               <td class="icyazi"><input name="kimlik" type="hidden" id="kimlik" value="<?php echo $row_tanitim['kimlik']; ?>" /></td>
               <td class="icyazi">&nbsp;</td>
               <td>                 <input name="button" type="submit" class="buton" id="button" onclick="YY_checkform('form1','eposta','#S','2','E - Posta');return document.MM_returnValue" value="Güncelle" />               </td>
             </tr>
             <tr>
               <td colspan="2" class="baslik"><div align="right">*</div></td>
