...
if (isset($_POST[$MM_flag])) {
  $MM_dupKeyRedirect="yonetim_kullanici_hata.php";
  $loginUsername = $_POST['kimlik'];
  $LoginRS__query = sprintf("SELECT kimlik FROM lms_kullanici WHERE kimlik=%s", GetSQLValueString($loginUsername, "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO lms_kullanici (kimlik, sifre, yetki, ad, soyad, eposta, web) VALUES (%s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "yonetim_kullanici_islem_ok.php";
  if (isset($_SERVER['QUERY_STRING'])) {
       ...
       <tr>
         <td width="60%" valign="top"><form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
           <table width="100%" border="0" cellspacing="2" cellpadding="3">
             <tr>
               <td colspan="3" class="baslik">Yeni Kullanıcı Ekle</td>
             </tr>
             <tr>
             ...
             <tr>
               ...
               <td><input name="sifre" type="text" class="metinkutusu" id="sifre" size="20" maxlength="20" />
             ...
             <tr>
               ...
               <td><label>
                 <select name="yetki" class="metinkutusu" id="yetki">
                   <option value="VT" selected="selected">Seçiniz</option>
                   <?php
do {  
?>
...
?>
             ...
             <tr>
               ...
               <td class="icyazi"><strong>:</strong></td>
               <td><input name="ad" type="text" class="metinkutusu" id="ad" size="30" maxlength="40" />
                   <span class="baslik">*</span></td>
             </tr>
             <tr>
               <td nowrap="nowrap" class="icyazi"><strong>Soyad</strong></td>
               <td class="icyazi"><strong>:</strong></td>
               <td><input name="soyad" type="text" class="metinkutusu" id="soyad" size="30" maxlength="40" />
                   <span class="baslik">*</span></td>
             </tr>
             <tr>
               <td nowrap="nowrap" class="icyazi"><strong>E - Posta</strong></td>
               <td class="icyazi"><strong>:</strong></td>
               <td><input name="eposta" type="text" class="metinkutusu" id="eposta" size="40" maxlength="50" />
                   <span class="baslik">*</span></td>
             </tr>
             <tr>
               <td nowrap="nowrap" class="icyazi"><strong>Web</strong></td>
               <td class="icyazi"><strong>:</strong></td>
               <td><input name="web" type="text" class="metinkutusu" id="web" value="http://" size="40" maxlength="50" /></td>
             </tr>
             <tr>
               <td nowrap="nowrap" class="icyazi">&nbsp;</td>
               <td class="icyazi">&nbsp;</td>
               <td><label>
                 <input name="button" type="submit" class="buton" id="button" onclick="YY_checkform('form1','kimlik','#q','0','Kullanıcı Adı','sifre','#q','0','Şifre','ad','#q','0','Ad','soyad','#q','0','Soyad','eposta','#S','2','E - Posta','yetki','#q','1','Yetki');return document.MM_returnValue" value="Yeni Kullanıcı Ekle" />
               </label></td>
             </tr>
             <tr>
