...
if (isset($_GET['kimlik'])) {
  $colname_goster = $_GET['kimlik'];
}
mysql_select_db($database_lmscon, $lmscon);
$query_goster = sprintf("SELECT K.*, S.aciklama FROM lms_kullanici K, lms_seviye S WHERE kimlik = %s AND K.yetki = S.yetki", GetSQLValueString($colname_goster, "text"));
$goster = mysql_query($query_goster, $lmscon) or die(mysql_error());
   ...
   <td rowspan="2" class="ustbaslik"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         ...
         <td width="97%">Kullanıcı Bilgileri</td>
       </tr>
     </table>
       ...
       <tr>
         <td width="60%" valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
           <tr>
             ...
             <td width="149" rowspan="5" align="center" valign="middle" bgcolor="#CCCCCC"><img src="avatar/<?php echo $row_goster['kimlik']; ?>.jpg" width="125" height="125" border="0" lowsrc="avatar/avatar.jpg" /></td>
           </tr>
           
           <tr>
             <td width="98" nowrap="nowrap" class="icyazi"><strong>Kullanıcı Adı</strong></td>
             <td width="4" class="icyazi"><strong>:</strong></td>
             <td width="224" class="icyazi"><?php echo $row_goster['kimlik']; ?></td>
             </tr>
           <tr>
             <td nowrap="nowrap" class="icyazi"><strong>Yetki Seviyesi</strong></td>
             <td class="icyazi"><strong>:</strong></td>
             <td class="icyazi"><?php echo $row_goster['yetki']; ?> - <?php echo $row_goster['aciklama']; ?></td>
             </tr>
           <tr>
             <td nowrap="nowrap" class="icyazi"><strong>Ad</strong></td>
             <td class="icyazi"><strong>:</strong></td>
             <td class="icyazi"><?php echo $row_goster['ad']; ?></td>
             </tr>
           <tr>
             <td nowrap="nowrap" class="icyazi"><strong>Soyad</strong></td>
             <td class="icyazi"><strong>:</strong></td>
             <td class="icyazi"><?php echo $row_goster['soyad']; ?></td>
             </tr>
           <tr>
             <td nowrap="nowrap" class="icyazi"><strong>E - Posta</strong></td>
             <td class="icyazi"><strong>:</strong></td>
             <td colspan="2" class="icyazi"><a href="mailto:<?php echo $row_goster['eposta']; ?>"><?php echo $row_goster['eposta']; ?></a></td>
             </tr>
           <tr>
             <td nowrap="nowrap" class="icyazi"><strong>Web</strong></td>
             <td class="icyazi"><strong>:</strong></td>
             <td colspan="2" class="icyazi"><a href="<?php echo $row_goster['web']; ?>" target="_blank"><?php echo $row_goster['web']; ?></a></td>
           </tr>
           <tr>
           ...
           <tr>
             <td colspan="4"><table width="100%" border="0" cellspacing="2" cellpadding="3">
               <tr>
                 <td width="6%"><a href="yonetim_kullanici_guncelle.php?<?php echo $MM_keepURL; ?>"><img src="simgeler/del_24.gif" alt="Sil" width="24" height="24" border="0" onclick="GP_popupConfirmMsg('Kullan&#305;c&#305; sistemden tamamen silinecektir?');return document.MM_returnValue" /></a></td>
                 <td width="94%" class="arabaslik">Kullanıcıyı sistemden tamamen sil</td>
               </tr>
               <tr>
                 <td><a href="yonetim_kullanici_guncelle.php?<?php echo $MM_keepURL; ?>"><img src="simgeler/edit_24.gif" alt="G&uuml;ncelle" width="24" height="24" border="0" /></a></td>
                 <td class="arabaslik">Kullanıcı bilgilerini güncelle</td>
               </tr>
               <tr>
                 <td height="30"><a href="profil_mesaj.php?<?php echo $MM_keepURL; ?>"><img src="simgeler/mail_24.gif" width="24" height="24" border="0" /></a></td>
                 <td class="arabaslik">Kullanıcıya sistem içerisinden mesaj at</td>
               </tr>
             </table></td>
           </tr>
         </table></td>
