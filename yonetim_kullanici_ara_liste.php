             ...
             <table width="100%" border="0" cellspacing="2" cellpadding="3">
               ...
               <?php do { ?>
                 <tr>
                   ...
                   <td width="9%" class="icyazi"><a href="profil_mesaj.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."kimlik=".$row_sonuc['kimlik'] ?>"><img src="simgeler/mail_16.gif" alt="Mesaj at" width="16" height="16" border="0" /></a></td>
                 </tr>
