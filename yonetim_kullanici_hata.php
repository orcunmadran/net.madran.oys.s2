   ...
   <td rowspan="2" class="ustbaslik"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         ...
         <td width="93%">Kullanıcı İşlemleri</td>
         <td>&nbsp;</td>
       </tr>
     </table>
  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       ...
       <tr>
         <td>&nbsp;</td>
         <td class="arabaslik">Belirlemiş olduğunuz kullanıcı adı kullanımda.</td>
       </tr>
       <tr>
         <td>&nbsp;</td>
         <td class="icyazi"> Yeni bir kullanıcı eklemek için <a href="javascript:history.back()">tıklayınız</a>.</td>
       </tr>
     </table>
   <!-- InstanceEndEditable --></td>
