...
<meta http-equiv="Refresh" content="3;URL=yonetim_kullanici.php" />
<!-- InstanceEndEditable -->
<style type="text/css">
<!--
body {
...
<!-- fwtable fwsrc="lms_ic.png" fwpage="LMS ic" fwbase="lms_ic.gif" fwstyle="Dreamweaver" fwdocid = "52238024" fwnested="0" -->
  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td class="arabaslik">İşleminiz başarıyla gerçekleştirildi.</td>
       </tr>
       <tr>
         <td class="icyazi">Kullanıcı işlemleri paneline yönlendiriliyorsunuz.</td>
       </tr>
       <tr>
         <td class="icyazi">Yönlendirme çalışmazsa lütfen <a href="yonetim_kullanici.php">tıklayınız</a>.</td>
       </tr>
     </table>
   <!-- InstanceEndEditable --></td>
