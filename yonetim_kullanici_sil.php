...
if ((isset($_GET['kimlik'])) && ($_GET['kimlik'] != "")) {
  $deleteSQL = sprintf("DELETE FROM lms_kullanici WHERE kimlik=%s",
                       GetSQLValueString($_GET['kimlik'], "text"));

  mysql_select_db($database_lmscon, $lmscon);
  $Result1 = mysql_query($deleteSQL, $lmscon) or die(mysql_error());

  $deleteGoTo = "yonetim_kullanici_ara_liste.php";
