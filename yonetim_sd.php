...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE lms_kullanici SET sifre=%s WHERE kimlik=%s",
  ...
  $updateGoTo = "yonetim_islem_ok.php";
  if (isset($_SERVER['QUERY_STRING'])) {
       ...
       <tr>
         <td width="60%"><form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
           <table width="100%" border="0" cellspacing="2" cellpadding="3">
             <tr>
               <td width="24%" class="icyazi"><strong>Eski Şifre</strong></td>
               <td width="2%" class="icyazi"><strong>:</strong></td>
               <td width="74%"><label>
                 <input name="eski" type="password" class="metinkutusu" id="eski" size="20" maxlength="20" />
                 <span class="baslik">*</span></label></td>
             </tr>
             <tr>
               <td class="icyazi"><strong>Yeni Şifre</strong></td>
               <td class="icyazi"><strong>:</strong></td>
               <td><label>
               <input name="yeni" type="password" class="metinkutusu" id="yeni" size="20" maxlength="20" />
               <span class="baslik">*</span></label></td>
             </tr>
             <tr>
               <td class="icyazi"><strong>Yeni Şifre Tekrar</strong></td>
               <td class="icyazi"><strong>:</strong></td>
               <td><label>
               <input name="sifre" type="password" class="metinkutusu" id="sifre" size="20" maxlength="20" />
               <span class="baslik">*</span></label></td>
             </tr>
             <tr>
               <td class="icyazi"><input name="kimlik" type="hidden" id="kimlik" value="<?php echo $row_tanitim['kimlik']; ?>" /></td>
               <td class="icyazi">&nbsp;</td>
               <td>                 <input name="button" type="submit" class="buton" id="button" onclick="YY_checkform('form1','eski','#q','0','Eski şifre.','yeni','#q','0','Yeni şifre','sifre','#yeni','6','Yeni şifre tekrarı hatalı');return document.MM_returnValue" value="Şifre Değiştir" />               </td>
             </tr>
             <tr>
