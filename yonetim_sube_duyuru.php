  ...
  <tr>
   ...
   <td rowspan="2" class="ustbaslik"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="7%"><a href="yonetim_sube_duyurular.php"><img src="simgeler/back_24.gif" alt="Geri dön" width="24" height="24" border="0" /></a></td>
     ...
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       ...
       <tr>
         ...
         <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
           <tr>
             <td width="5%"><a href="yonetim_sube_duyuru_sil.php?<?php echo $MM_keepURL; ?>"><img src="simgeler/del_24.gif" alt="Sil" width="24" height="24" border="0" onclick="GP_popupConfirmMsg('Haber - Duyuru - Etkinlik sistemden tamamen silinecektir!');return document.MM_returnValue" /></a></td>
             <td width="95%" class="arabaslik">Duyuru Sil</td>
           </tr>
           <tr>
             <td><a href="yonetim_sube_duyuru_guncelle.php?<?php echo $MM_keepURL; ?>"><img src="simgeler/edit_24.gif" alt="G&uuml;ncelle" width="24" height="24" border="0" /></a></td>
             <td><span class="arabaslik">Duyuru Güncelle</span></td>
           </tr>
         </table></td>
       </tr>
     </table>
