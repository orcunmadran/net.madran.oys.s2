...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertGoTo = "yonetim_sube_duyurular.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_lmscon, $lmscon);
$query_derskod = sprintf("SELECT DISTINCT CONCAT(DE.kod, ' - ', SU.kod, ' ', DE.ad) AS dersbilgi, SU.subeadi FROM lms_ders DE, lms_sube SU, lms_kullanici K WHERE DE.no = SU.dersno AND SU.kimlik = %s AND SU.kimlik = K.kimlik AND DE.aktif = 'EVET'", GetSQLValueString($deger_derskod, "text"));
...
<!-- fwtable fwsrc="lms_ic.png" fwpage="LMS ic" fwbase="lms_ic.gif" fwstyle="Dreamweaver" fwdocid = "52238024" fwnested="0" -->
   ...
   <td rowspan="2" class="ustbaslik"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         ...
         <td width="93%">Şube Duyuru İşlemleri</td>
       </tr>
     </table>
  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="60%" class="baslik">Yeni Duyuru Ekle</td>
         <td width="40%" class="baslik"> <div align="center">Duyuru Arşivi</div></td>
       </tr>
       <tr>
...
do {  
?>
                     <option value="<?php echo $row_derskod['subeadi']?>"><?php echo $row_derskod['dersbilgi']?></option>
                     <?php
...
?>
             ...
             <tr>
               <td colspan="3" class="arabaslik"> Duyuru Ayrıntı</td>
             </tr>
             <tr>
  ...
  ?>
             ...
             <tr>
               <td colspan="3" class="icyazi"><label>
                 <input name="button" type="submit" class="buton" id="button" onclick="YY_checkform('form1','baslik','#q','0','Başlık','baslama','#q','0','Yayın Tarihi','bitis','#q','0','Yayın Bitiş Tarihi','kod','#q','1','Duyuru Kod','kimlik','#q','0','Kullanıcı Adı');return document.MM_returnValue" value="Yeni Duyuru Ekle" />
               </label></td>
             </tr>
           </table>
         ...
         <td valign="top"><?php if ($totalRows_duyuru == 0) { // Show if recordset empty ?>
             <table width="100%" border="0" cellspacing="2" cellpadding="3">
               <tr>
                 <td class="arabaslik"><div align="center">Arşivde yer alan duyuru bulunmamaktadır.</div></td>
               </tr>
             </table>
           ...
           <?php if ($totalRows_duyuru > 0) { // Show if recordset not empty ?>
             <table width="95%" border="0" align="center" cellpadding="3" cellspacing="2">
               ...
               <?php do { ?>
                 <tr>
                   <td valign="top" class="icyazi"><a href="yonetim_sube_duyuru.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."duyuruno=".$row_duyuru['no'] ?>"><?php echo $row_duyuru['baslik']; ?></a></td>
                   <td width="1%" valign="top" class="icyazi"><div align="center"><a href="yonetim_sube_duyuru_sil.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."duyuruno=".$row_duyuru['no'] ?>"><img src="simgeler/del_16.gif" title="Sil" width="16" height="16" border="0" onclick="GP_popupConfirmMsg('Haber - Duyuru - Etkinlik sistemden tamamen silinecektir!');return document.MM_returnValue" /></a></div></td>
                   <td width="1%" valign="top" class="icyazi"><div align="center"><a href="yonetim_sube_duyuru_guncelle.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."duyuruno=".$row_duyuru['no'] ?>"><img src="simgeler/edit_16.gif" title="Güncelle" width="16" height="16" border="0" /></a></div></td>
                 </tr>
