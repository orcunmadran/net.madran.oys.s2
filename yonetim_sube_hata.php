  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       ...
       <tr>
         <td>&nbsp;</td>
         <td class="arabaslik">Belirlemiş olduğunuz özellikler ile daha önce bir şube açılmıştır.</td>
       </tr>
       <tr>
         <td>&nbsp;</td>
         <td class="icyazi"> Yeni bir şube açmak için <a href="javascript:history.back()">tıklayınız</a>.</td>
       </tr>
     </table>
   <!-- InstanceEndEditable --></td>
