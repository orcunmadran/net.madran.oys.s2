  ...
  <tr>
   ...
   <td rowspan="2" class="ustbaslik"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="7%"><a href="javascript:history.back()"><img src="simgeler/back_24.gif" alt="Öğrenci İşlemleri paneline geri dön" width="24" height="24" border="0" /></a></td>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         ...
         <td width="96%" class="baslik">Hata Mesajı</td>
       </tr>
       <tr>
         <td>&nbsp;</td>
         <td class="arabaslik">Öğrenci zaten bu şubeye kayıtlı.</td>
       </tr>
       <tr>
         <td>&nbsp;</td>
         <td class="icyazi"> Farklı bir öğrenci eklemek için <a href="javascript:history.back()">tıklayınız</a>.</td>
       </tr>
     </table>
   <!-- InstanceEndEditable --></td>
