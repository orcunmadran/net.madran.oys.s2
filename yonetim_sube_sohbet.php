   ...
   <td rowspan="2" class="ustbaslik"><!-- InstanceBeginEditable name="Baslik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         ...
         <td width="97%">Sohbet Odaları İşlemleri</td>
       </tr>
     </table>
         ...
         <td><table border="0" cellspacing="5" cellpadding="5">
           <?php if ($totalRows_subeler == 0) { // Show if recordset empty ?>
             <tr>
               <td colspan="5"><table width="100%" border="0" cellspacing="2" cellpadding="3">
                      <tr>
                        ...
                        <td width="96%" class="baslikMAVI">Sistem Mesajı</td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td class="icyazi"><p class="arabaslik">Sistem tarafından size yüklenen herhangi bir ders  bulunmamaktadır.</p>
                        <p>Sohbet odaları işlemleri üzerinize yüklü bir ders olduğunda aktif hale gelmektedir.</p></td>
                      </tr>
			...
			<?php if ($totalRows_subeler > 0) { ?>
             <tr>
               <td colspan="5" nowrap="nowrap" class="baslik">Sorumluluğunuzda Bulunan Dersler</td>
             </tr>
             <tr>
             <td nowrap="nowrap" class="arabaslik"><div align="center">Ders Kodu</div></td>
             <td nowrap="nowrap" class="arabaslik"><div align="center">Şube</div></td>
             <td nowrap="nowrap" class="arabaslik">Dersin Adı</td>
             <td nowrap="nowrap" class="arabaslik">Ders Sorumlusu</td>
             <td nowrap="nowrap" class="arabaslik">İşlemler</td>
             </tr>
           <tr>
             <td nowrap="nowrap" class="icyazi"><hr align="center" size="1" /></td>
             <td nowrap="nowrap" class="icyazi"><hr align="center" size="1" /></td>
             <td nowrap="nowrap" class="icyazi"><hr align="center" size="1" /></td>
             <td nowrap="nowrap" class="icyazi"><hr align="center" size="1" /></td>
             <td nowrap="nowrap" class="icyazi"><hr align="center" size="1" /></td>
           ...
           <?php do { ?>
             <tr>
               <td valign="top" nowrap="nowrap" class="icyazi"><div align="center"><?php echo $row_subeler['kod']; ?></div></td>
               <td valign="top" nowrap="nowrap" class="icyazi"><div align="center"><?php echo $row_subeler['subekodu']; ?></div></td>
               <td valign="top" nowrap="nowrap" class="icyazi"><?php echo $row_subeler['ad']; ?></td>
               <td valign="top" nowrap="nowrap" class="icyazi"><?php echo $row_subeler['adsoyad']; ?>                 <div align="left"></div></td>
               <td valign="top" nowrap="nowrap" class="icyazi"><a href="yonetim_sube_sohbet_belirle.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."subeno=".$row_subeler['subeno'] ?>">Sohbet gün ve saatini belirle</a></td>
             </tr>
