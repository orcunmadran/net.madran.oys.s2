...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO lms_sube_sohbet (subeno, gun, saat, ad, sifre) VALUES (%s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "yonetim_sube_sohbet_belirle.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_GET['subeno'])) {
  $degeriki_subeler = $_GET['subeno'];
}
mysql_select_db($database_lmscon, $lmscon);
$query_subeler = sprintf("SELECT DE.kod AS derskodu, CONCAT(DE.kod, ' - ', SU.kod) AS odaadi, SU.no AS subeno, SU.kod AS subekodu FROM lms_ders DE, lms_sube SU WHERE DE.no = SU.dersno AND SU.kimlik = %s AND DE.aktif = 'EVET' AND SU.no = %s", GetSQLValueString($deger_subeler, "text"),GetSQLValueString($degeriki_subeler, "int"));
...
$veri_sohbet = "-1";
if (isset($_GET['subeno'])) {
  $veri_sohbet = $_GET['subeno'];
}
mysql_select_db($database_lmscon, $lmscon);
$query_sohbet = sprintf("SELECT GN.gun AS tamgun, SU.* FROM lms_sube_sohbet SU, lms_gunler GN WHERE SU.gun = GN.deger AND SU.subeno = %s ORDER BY GN.no", GetSQLValueString($veri_sohbet, "int"));
...
<!-- fwtable fwsrc="lms_ic.png" fwpage="LMS ic" fwbase="lms_ic.gif" fwstyle="Dreamweaver" fwdocid = "52238024" fwnested="0" -->
  ...
  <tr>
   ...
   <td colspan="19" valign="top"><!-- InstanceBeginEditable name="İcerik" -->
     <table width="100%" border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="60%"><span class="baslik"><?php echo $row_subeler['derskodu']; ?> - <?php echo $row_subeler['subekodu']; ?> Sohbet Gün ve Saatleri</span></td>
         <td class="baslik">Yeni Sohbet Gün ve Saati Belirle</td>
       </tr>
       <tr>
         <td valign="top"><?php if ($totalRows_sohbet == 0) { // Show if recordset empty ?>
             <table width="100%" border="0" cellspacing="2" cellpadding="3">
               <tr>
                 <td class="arabaslik">Bu şube için belirlenmiş sohbet gün ve saati bulunmamaktadır.</td>
               </tr>
             </table>
           ...
           <?php if ($totalRows_sohbet > 0) { // Show if recordset not empty ?>
             <table border="0" cellpadding="3" cellspacing="2">
               <tr>
                 <td nowrap="nowrap" class="arabaslik">Gün</td>
                 <td nowrap="nowrap" class="arabaslik">Saat</td>
                 <td nowrap="nowrap" class="arabaslik">Oda Adı</td>
                 <td nowrap="nowrap" class="arabaslik">Oda Şifresi</td>
                 <td colspan="2" nowrap="nowrap" class="arabaslik"><div align="center">İşlemler</div></td>
               </tr>
               <tr>
                 <td class="icyazi"><hr size="1" /></td>
                 <td class="icyazi"><hr size="1" /></td>
                 <td class="icyazi"><hr size="1" /></td>
                 <td class="icyazi"><hr size="1" /></td>
                 <td class="icyazi"><hr size="1" /></td>
               ...
               <?php do { ?>
                 <tr>
                   <td class="icyazi"><?php echo $row_sohbet['tamgun']; ?></td>
                   <td class="icyazi"><?php echo $row_sohbet['saat']; ?></td>
                   <td class="icyazi"><?php echo $row_sohbet['ad']; ?></td>
                   <td class="icyazi"><?php echo $row_sohbet['sifre']; ?></td>
                   <td class="icyazi"><div align="center"> <a href="yonetim_sube_sohbet_sil.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."sohbetno=".$row_sohbet['no'] ?>"><img src="simgeler/del_16.gif" alt="Sil" width="16" height="16" border="0" onclick="GP_popupConfirmMsg('Sohbet bilgisi sistemden tamamen silinecektir!');return document.MM_returnValue" /></a></div></td>
                   <td class="icyazi"><div align="center"><a href="yonetim_sube_sohbet_guncelle.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."sohbetno=".$row_sohbet['no'] ?>"><img src="simgeler/edit_16.gif" alt="G&uuml;ncelle" width="16" height="16" border="0" /></a></div></td>
                 </tr>
...
?>
             ...
             <tr>
               ...
               <td width="11%" class="icyazi"><label>
                 <input name="saat" type="text" class="metinkutusu" id="saat" size="5" maxlength="5" />
               </label></td>
             ...
             <tr>
               ...
               <td class="icyazi"><strong>:</strong></td>
               <td colspan="3" class="icyazi"><input name="ad" type="text" class="metinkutusu" id="ad" value="<?php echo $row_subeler['odaadi']; ?>" size="20" maxlength="30" />
             ...
             <tr>
               ...
               <td class="icyazi"><strong>:</strong></td>
               <td colspan="3" class="icyazi"><label>
                 <input name="sifre" type="text" class="metinkutusu" id="sifre" size="20" maxlength="20" />
                 <span class="baslik">*</span></label></td>
             </tr>
             <tr>
               <td nowrap="nowrap" class="icyazi"><input name="subeno" type="hidden" id="subeno" value="<?php echo $row_subeler['subeno']; ?>" /></td>
               <td class="icyazi">&nbsp;</td>
               <td colspan="3" class="icyazi"><label>
                 <input name="button" type="submit" class="buton" id="button" onclick="YY_checkform('form1','saat','#q','0','Saat','ad','#q','0','Ad','sifre','#q','0','Şifre','gun','#q','1','Gün');return document.MM_returnValue" value="Gönder " />
               </label></td>
             </tr>
             <tr>
